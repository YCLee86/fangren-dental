...
16. **照片與窄帶之間看得到一條分界線** —— **提案中**（2026-08-12），
    ...
    >   「從黑邊到深藍有點短、很突兀」。攤開之後 53px → 107px，最陡的一列少 40%。
    >   拉長不會有色帶：Chromium 自己抖動，實測 107px 裡有 73 個色階。
