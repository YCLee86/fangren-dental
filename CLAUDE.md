...
| 贋復假牙的藍 | **填色 `#4a5789`、白底的字 `#364067`**（F2·T1，2026-08-09）。彩度要跟著亮度按色域比例走，固定住會變灰、和矯正撞在一起 | [PALETTE.md](PALETTE.md) 第六之十節 |
...
| 一般牙科・牙周・創辦醫師的綠 | **套色 `#3f654a`、字 `#2c5238`**（⑪·Ⓑ，2026-08-09）。色相＝花藝實測「枝葉亮處」的色相；兩階只差亮度 7.9。`--chair` 釋出但留著 | [PALETTE.md](PALETTE.md) 第六之十一節第七小節 |
...
5. **贋復的藍偏藍紫要不要修、修到哪一階**（2026-08-09）。提亮時鎖死色相造成的：
   h 287 在 L\* 19 是海軍藍，提到 L\* 38 就讀成藍紫。三案 Ⓐ／Ⓑ／Ⓒ，
   提案頁 `preview/spec-prosth-bluer/`，見 [PALETTE.md](PALETTE.md) 第六之十三節。
6. **⚠ 牙周想用矯正提亮案的 Ⓒ，但那會撞色**（ΔE 6.4，出局線是 6.1）——
   Ⓐ Ⓑ Ⓒ 是同一色相的三個高度，不是三個顏色。三條路寫在
   [PALETTE.md](PALETTE.md) 第六之十四節，**還沒問過使用者要走哪一條。**
7. **[PALETTE.md](PALETTE.md) 第六之八節的三組要重排**（2026-08-09 起）。
   顯微根管離開苔綠之後，綠色段只剩一般牙周 174，「保留與延續」那一組拆散了；
   紅要接進暖色段（兒牙 35 旁邊）還是自己成一段，還沒重寫。
（兒牙白字那一件已經結案了，見上面的定案表。口腔外科的紫已定案 `#8e6299`／`#784e84`，
見 PALETTE.md 第六之九節與 `preview/spec-surg-violet/`；贋復假牙的藍已定案
`#4a5789`／`#364067`，見第六之十節與 `preview/spec-prosth-blue/`；顯微根管的紅已定案
`#ae4f4d`／`#89202d`，見第六之十一節與 `preview/spec-endo-red-all/`。）
