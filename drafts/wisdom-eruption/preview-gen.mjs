...
function BODY() { return `    <p class="lede">「你的智齒是阻生齒，建議拔掉。」很多人第一次聽到這句話，是在大學時期的一張全景 X 光片前面。也有人剛好相反——二十幾歲了還沒看到智齒冒出來，以為自己天生就沒有。智齒是全口最後報到的牙齒，也是變異最大的一顆；但<strong>真正要緊的不是它什麼時候長出來，是你什麼時候把「留還是拔」判斷清楚。判斷得早，該拔的那幾顆會好拔很多。</strong></p>
    ...
    <p>被告知「你的智齒是阻生齒」的時候，聽起來像是一個已經確定的結論。但長期追蹤的研究說，這個判斷在二十幾歲這幾年還會改變。</p>
