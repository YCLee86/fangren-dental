...
out = out.slice(0, bodyStart) + `    <p class="lede">半年洗一次牙，是給大多數人的間隔。它預設你的唾液量夠、傷口癒合正常、拿牙刷的手還穩。</p>
    <p>這些條件少了一項，同樣的三個月，嘴裡累積出來的東西就和別人不一樣。健保為這樣的人另外開了一條路——洗牙的間隔縮短到三個月，塗氟也是，而且<strong>塗氟不再只是小孩才做的事</strong>。</p>
    ...
    <h2>哪些人適用</h2>
    <p><strong>洗牙</strong>（正式名稱是牙結石清除）：六十五歲以上、心血管疾病、洗腎（血液透析或腹膜透析）、正在使用骨質疏鬆藥物、惡性腫瘤治療中、口乾症、糖尿病、孕婦，以及部分身心障礙類別及等級者。健保把這些人分在幾個名稱不一樣的專案裡，但對你來說是同一件事：間隔從半年縮短到三個月。</p>
    <p><strong>塗氟</strong>也是三個月一次，條件是已經有過蛀牙。</p>
    <p>簡單講：年紀到了、有慢性病在追蹤、正在吃骨鬆藥或做癌症治療、在洗腎，大概都在範圍內。類別與條件健保署會調整，實際以就診當時的公告為準；不確定自己算不算，掛號的時候可以先問。</p>
    <p><strong>三個月是間隔，不是期限</strong>——滿三個月不必急著當天掛號，牙齒也不會因為晚了幾天就出事。實際多久檢查一次，醫師會看你的牙齦狀況與牙結石堆積的速度來判斷。</p>
    ...
    <dl class="keypoints">
      <dt>三個月洗一次牙，哪些人適用？</dt>
      <dd>六十五歲以上、心血管疾病、洗腎、使用骨質疏鬆藥物、惡性腫瘤治療中、口乾症、糖尿病、孕婦與部分身心障礙者。健保分在幾個名稱不同的專案裡，對民眾來說都是同一件事：間隔從半年縮短到三個月。實際條件依就診當時健保署公告為準。</dd>

      <dt>三個月的檢查，和半年那一次有什麼不一樣？</dt>
      <dd>半年一次，中間那半年沒有人看。間隔縮短之後，剛開始的蛀牙這一次就看得到、接著安排處理，不必等它變大。</dd>

      <dt>滿三個月一定要馬上來嗎？</dt>
      <dd>不必。三個月是間隔不是期限，晚幾天不會出事。實際多久檢查一次，由醫師依牙齦狀況與牙結石堆積的速度判斷。</dd>

      <dt>大人也可以塗氟嗎？</dt>
      <dd>可以。氟的作用是讓被酸侵蝕、還沒破洞的地方重新變硬，和年紀無關；條件是已經有過蛀牙。</dd>
