...
out = out.slice(0, metaStart) + `<script type="application/json" id="post-meta">
{
  ...
  "title": "${TITLE}",
  "excerpt": "半年一次，是給大多數人的間隔。正在洗腎、在吃骨鬆藥、癌症治療中，或是年紀到了牙根露出來——這幾種嘴，和半年這個數字對不上。健保為他們另外開了一條路：洗牙與塗氟都縮短到三個月，而且塗氟不再只是小孩的事。",
  "tag": "定期檢查",
  "author": "芳仁牙醫診所 編輯室",
  "published": "【上線那天填】",
  "hero": "【還沒畫】",
...
out = out.slice(0, bodyStart) + `    <p class="lede">半年洗一次牙，是給大多數人的間隔。這個數字背後有幾個預設：唾液的量夠、傷口癒合正常、拿牙刷的手還穩、飯後還記得刷。</p>
    <p>這些條件少了一項，同樣的三個月，嘴裡累積出來的東西就和別人不一樣。健保這幾年為這樣的人另外開了一條路——洗牙的間隔縮短到三個月，塗氟也是，而且<strong>塗氟不再只是小孩才做的事</strong>。</p>

    <h2>為什麼是三個月</h2>
    <p>牙菌斑留在牙面上超過一兩天，唾液裡的鈣與磷會沉積進去，讓它逐漸鈣化成牙結石；一旦鈣化，牙刷與牙線就拿它沒辦法了（這一段的細節寫在<a href="../../posts/regular-checkup/">〈半年一次的洗牙〉</a>那一篇）。</p>
    <p>牙齦健康的人，半年一次還追得上這個速度。真正讓速度改變的是下面這幾件事：</p>
    <ul>
    ...
    <p>同樣三個月，這幾種情況累積出來的傷害，和一般人不是同一個量級。把間隔縮短，是為了讓檢查落在傷害累積起來之前。</p>

    <h2>不只是把牙結石清掉</h2>
    <p>縮短間隔，另一半的價值是<strong>被看到得早</strong>。</p>
    <p>半年一次，中間那半年是沒有人看的。對前面那幾類人來說，那半年剛好是蛀牙走得最快的一段——牙根露出來、嘴巴又乾，而且不一定會痛；等到下一次坐上診療椅，常常已經不是補一補就好的規模。</p>
    <p>三個月檢查一次，等於把那段空白切短。一顆剛開始的蛀牙，這一次就看得到、接著安排處理，不必等它自己長大。真正的差別不在洗牙的那半小時，在於<strong>你嘴裡的變化不會有半年沒人看見</strong>。</p>

    <h2>哪些人適用</h2>
    <p>這是健保的一個專案，對象是全身狀況讓牙齒比較容易出問題的幾類人；芳仁有簽這個專案。</p>
    <ul>
      <li><strong>洗牙</strong>（正式名稱是牙結石清除）：六十五歲以上、心血管疾病、洗腎（血液透析或腹膜透析）、正在使用骨質疏鬆藥物、惡性腫瘤治療中、口乾症，以及部分身心障礙類別及等級者。孕婦與糖尿病另有各自的規定。</li>
      <li><strong>塗氟</strong>（正式名稱是含氟藥物塗布）：上面這些，再加上糖尿病；條件是已經有過蛀牙。</li>
    </ul>
    <p>簡單講：年紀到了、有慢性病在追蹤、正在吃骨鬆藥或做癌症治療、在洗腎，大概都在範圍內。類別與條件健保署會調整，實際以就診當時的公告為準；不確定自己算不算，掛號的時候可以先問。</p>

    <h2>符合條件，不等於每三個月一定會做一次</h2>
    <p>健保放寬的是<strong>上限</strong>：它把「半年」那道門檻拿掉，讓需要的人來得及處理。至於這一次要不要洗、下一次隔多久，仍然是臨床判斷——醫師會看你的牙齦狀況、牙結石堆積的速度、平常刷得乾不乾淨，三個月、四個月、五個月都有可能。</p>
    <p>所以三個月不是一張到期要用掉的票，也不是一項功課。它的意思只有一句：<strong>如果你的狀況需要，制度這一關不會再擋著。</strong></p>
    ...
    <p>這兩類藥會影響顎骨的修復能力。真的必須拔牙的時候，傷口的處理會比一般人複雜。</p>
    <p>所以順序很重要：趁狀況穩定先把牙結石清掉、小蛀牙補起來，盡量不要走到必須拔牙那一步。如果你快要開始這類治療，在開始之前先做一次口腔檢查會更好——這一步是為了讓你在療程進行中間，不必再臨時處理牙齒的問題。</p>

    <h2>來的時候</h2>
    <ul>
      <li>洗牙的同一次會檢查牙菌斑、做潔牙指導，把一直沒刷到的位置指出來。</li>
      <li>洗牙和塗氟同一次做完，不必為了塗氟另外跑一趟。</li>
      <li><strong>把藥帶著。</strong>這幾類病人的用藥常會影響牙科的處置方式，尤其骨質疏鬆藥物與抗凝血劑；開藥的醫師如果特別交代過看牙要注意什麼，也請一起告訴我們。記不清楚藥名是正常的，把藥袋或用藥紀錄帶來最省事。</li>
    </ul>
    <p>牙齒的問題幾乎都是慢慢累積的，中間有很長一段時間處理得掉。如果你落在前面那幾類裡，下次來的時候讓醫師看一次你的間隔該不該縮短——這一件事現在就做得到。</p>

    <h2>重點整理</h2>
    <dl class="keypoints">
      <dt>三個月洗一次牙，哪些人適用？</dt>
      <dd>健保的高風險口腔照護專案涵蓋六十五歲以上、心血管疾病、洗腎、使用骨質疏鬆藥物、惡性腫瘤治療中、口乾症與部分身心障礙者，孕婦與糖尿病另有規定。類別與條件依就診當時健保署公告為準。</dd>

      <dt>三個月的檢查，和半年那一次有什麼不一樣？</dt>
      <dd>差別不只是洗牙洗得比較勤。半年一次，中間那半年沒有人看；對這幾類人來說，那正是蛀牙走得最快的一段。間隔縮短之後，剛開始的蛀牙這一次就看得到、接著安排處理，不必等它變大。</dd>

      <dt>符合資格，就一定會每三個月洗一次嗎？</dt>
      <dd>不是。健保放寬的是上限，不是排定的行程。這一次要不要洗、下一次隔多久，由醫師依牙齦狀況、牙結石堆積的速度與清潔習慣判斷，三到五個月都有可能。</dd>

      <dt>大人也可以塗氟嗎？</dt>
      <dd>可以。氟的作用是讓被酸侵蝕、還沒破洞的地方重新變硬，和年紀無關。健保的塗氟對象比洗牙多一項糖尿病，條件是已經有過蛀牙。</dd>
