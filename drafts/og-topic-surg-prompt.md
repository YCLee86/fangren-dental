...
## 十九、第八輪：拿掉口罩、病人換成年輕人＋同伴、神經管貼著牙走並掛警示、土要真的蓋住（2026-08-25）

使用者：

> ・「醫師跟助理**不要戴口罩**，好像看不出他們的表情。」
> ・「**病人年紀有點太大了**……通常來拔智齒的都是**二十幾歲的年輕人**，
>   　年輕人通常會有**同年齡的朋友陪，或是爸媽家人陪**，
>   　所以病人可以**再活潑一點**，現在這個病人看起來太老了。」
> ・「那個紫色的管線，**它的概念是神經管**。畫在下面我覺得蠻好，但是**到牙齒的時候
>   　要很貼近牙齒**，往上很貼近牙齒 —— 但**不要塞到牙齒裡**，就是**很貼近牙齒、
>   　在牙齒周圍，甚至到牙根那邊**，然後**一直連通到畫面的右邊**消失。」
> ・「那個牙齒雖然有一部分畫成虛線，**可是它不是真的埋在土裡**，土後面好像還是有個空間。
>   　**土應該要把它牙冠以下埋起來。**」
> ・「紫色管線因為是電線嘛，所以我找那個**高壓電的圖**，**標一些在那個管線上面或周圍**，
>   　代表那是一個電線管、**危險不要靠近**。」
> ・「**口腔外科是女醫師**，官網上有口腔外科的**短髮醫師圖片**，可能要拿來用。」
...
| 邊緣密度 | **30.1% ✓** | ≥ 30% |
| 無彩空白 | **0.5% ✓** | < 5% |
| 頂 17% 中位 RGB | 208/200/215（紫調足 ✓） | 藍 ≥ 178 |
| 頂 17% 被誰佔到 | 第 127 列才有線（襯砌邊） | 0 ✓ |
| 圖上有沒有字 | ⚠⚠ **有：`OH!`** | 一個字都不能有 |

⚠⚠ **`OH!` 是提示詞自己寫出來的。** 第六輪起我在病人那一段寫了
`MOUTH OPEN IN A BIG HAPPY "OH!"`，模型把引號裡的字當成要畫的內容。
**通則：提示詞裡不要出現任何被引號框起來的字串，連狀聲詞都不行** ——
要描述表情就寫幾何（嘴巴張成一個圓、眉毛揚高），不要給它一個「字」。
（同第四輪那次把 `GROUP A` 畫進圖裡，是同一類錯誤的第二次。）

### 這一輪的三個判斷

1. **帽子留著、口罩拿掉。** 使用者只說不要口罩；帽子是這張圖唯一帶著科別紫的東西。
   但「短髮女醫師」和「帽子把頭髮全包住」互相衝突 → 改成**帽子往後戴、露出瀏海與
   耳邊的短髮**，兩件事都成立。
2. **參考圖直接用站上那張〈拔智齒之後〉的 HERO** —— 使用者指的就是它
   （`assets/hero-wisdom-photo-2000.jpg`）。裁成兩張：
   `drafts/surg-doctor-ref.jpg`（短髮女醫師）、`drafts/surg-patient-ref.jpg`
   （赭黃上衣的年輕男病人）。**產生器 `drafts/surg-refs-crop.mjs` 進版控**，
   日後要重裁就跑它。
   ⚠ 這一次是**站上自己的插畫當參考圖**，比外面找的更安全：風格本來就一致。
3. **警示標誌只能用符號，不能用字。** 使用者給的是「高壓電・小心觸電」那種告示牌，
   但那上面全是字，而**圖上不放任何字**是硬規格（250px 也讀不出來）。
   → 改成**沒有字的黃色三角形＋黑色閃電**小牌，沿著管線插三面。
   ⚠ 這推翻了前幾輪 AVOID 裡的 `warning signs / hazard tape`（那是我推的 B 類），
   使用者指定要，就照做。
...
## 二十、第八輪的完整提示詞（2026-08-25，全新生成，可直接複製）
...
NOTHING IN THIS BRIEF MAY BE WRITTEN INTO THE PICTURE. No labels, no captions, no words, no
letters, no numbers, no exclamations, no sound effects, in any language - not on the walls, not
on the signs, not beside anybody's mouth. Draw feelings with faces and bodies, never with
written characters.
...
THE STORY IN ONE SENTENCE - THIS IS A TREASURE FIND, AND THAT IS THE WHOLE MOOD: deep underground
in a big reinforced tunnel, A WOMAN ORAL SURGEON with short hair, a violet surgical cap, a white
coat and scrubs is boring forward with A BIG WHITE HAND-HELD TUNNEL SHIELD, and she HAS JUST
UNCOVERED THE CROWN OF AN ENORMOUS TOOTH THAT LIES HORIZONTALLY IN THE EARTH, THREE QUARTERS OF
IT STILL BURIED - and her assistant, hauling the very thick hydraulic hose, and A YOUNG PATIENT
IN HIS TWENTIES WITH A FRIEND OF THE SAME AGE have all lit up with excitement: there it is.
Everybody is happy and lively. It is the moment of FINDING, not of fighting.
...
ALL THE ROUGH AND AWKWARD THINGS ARE OUTSIDE THE TUNNEL, IN THE CUTAWAY EARTH: in the brown
strata ABOVE the lined crown, BELOW the tunnel floor, and in the unexcavated ground at the
RIGHT-HAND END, embed SEVERAL BIG ROUNDED BOULDERS, A THICK OLD CERAMIC PIPE running diagonally,
A FAT WOODY TREE ROOT with smaller roots branching off it, A HALF-BURIED ROUND CLAY JAR, and a
scatter of smaller stones and root hairs. The lined tunnel VISIBLY DIPS AND BENDS to slip between
them, just missing each one. NONE of these objects is inside the tunnel and nothing touches them.

THE TOP STRIP OF THE PICTURE MUST STAY CALM AND EMPTY. The upper 17% (the top 105 pixels of 628)
is the smooth lined crown: one clean band of PALE LILAC-GREY (#d3cbdd) with at most two very
faint horizontal joint lines. IT MUST BE DISTINCTLY LILAC-TINTED - never a neutral grey, never
near-white, never brown. NOTHING may cross into it. Compose so that EVERY head and the top of the
tooth sit BELOW A LINE ONE FIFTH OF THE WAY DOWN FROM THE TOP (about 126 of the 628 pixels).
...
1. STYLE. Thin hand-drawn linework whose weight varies and sometimes breaks - NOT a thick even
   ...
   PERSON IS DRAWN WITH EXACTLY THE SAME LINE WEIGHT AND SOLIDITY - nobody is paler, softer or
   more transparent than anybody else. The four people look clearly different: different age,
   build, hair and clothes. Flat fills in two or three steps per colour, no gradients except to
   describe light. Fine paper grain over the whole image.

2. NOBODY WEARS A FACE MASK - WE MUST SEE EVERY EXPRESSION. The surgeon and the assistant wear
   their violet surgical caps but NO masks at all: their whole faces, mouths included, are
   visible and smiling. No mask on the chin, no mask in the hand, no mask anywhere.

3. THE SURGEON IS A WOMAN WITH SHORT HAIR, DRAWN FROM THE PROVIDED CHARACTER REFERENCE. A woman
   in her thirties or forties, SEEN FROM THE SIDE, FACING RIGHT, just right of centre, LEANING
   HER WEIGHT INTO THE MACHINE - one foot forward, one braced back, knees bent, both arms tight
   to her body. HER HAIR IS A SHORT DARK-BROWN BOB that ends at the jaw, with a soft fringe, and
   THE VIOLET CAP IS WORN PUSHED BACK ON HER HEAD so the fringe and the ends of the bob show
   clearly in front of it and below it - the cap is a soft tie-back surgical cap, PLAIN, WITH NO
   PATTERN, in muted violet (#8e6299, shaded #784e84). She wears AN OPEN WHITE COAT over pale
   grey-violet scrubs (#c9bcd0). SHE IS SMILING WITH DELIGHT: mouth curved up and open a little,
   eyes creased into two happy upward curves, eyebrows raised. She is about 62% of the picture
   height, strong and in control, NOT straining painfully, NOT looking at the viewer.

4. THE GIANT TOOTH LIES FLAT AND IS PROPERLY BURIED IN SOLID EARTH - THE LAST VERSION LEFT AN
   EMPTY HOLLOW AROUND IT, WHICH IS WRONG. ITS LONG AXIS IS HORIZONTAL, PARALLEL TO THE TUNNEL
   FLOOR - lying down like a fallen pillar, NOT upright, NOT tilted. THE CROWN END POINTS LEFT
   towards the machine; THE TWO THICK ROOTS POINT RIGHT, sticking out horizontally towards the
   right edge, never downwards. ONLY THE CROWN - the left-hand quarter - IS EXPOSED, drawn SOLID
   CREAM-WHITE (#f2ece2, shaded #d9cfc0), bright in the lamplight, with three or four short
   straight light strokes radiating from it. EVERYTHING BEYOND THE CROWN IS PACKED SOLIDLY UNDER
   THE SOIL: THE BROWN EARTH IS DRAWN OVER IT, complete with its own strata lines, pebbles and
   speckles, with NO cavity, NO air gap, NO open chamber and NO dark void anywhere around the
   buried part - the soil touches the tooth everywhere. The buried three quarters are shown ONLY
   as a DASHED OR DOTTED OUTLINE with a slightly paler tint of that same brown inside it, like an
   excavation survey drawing, so we understand the huge object continues under solid ground.
   Laid out flat the whole tooth is LONGER THAN THE SURGEON IS TALL, spanning most of the
   right-hand half of the picture, its body about 45% of the picture height thick. IT HAS NO
   FACE: no eyes, no mouth, nothing.

5. THE NERVE PIPE HUGS THE TOOTH AND RUNS OFF THE RIGHT EDGE - THIS IS THE THING THAT MUST NOT BE
   TOUCHED. A smooth rounded pipe filled with gently glowing pale violet light (#b48fc0 with a
   lighter #d6bfdd core) enters at the LEFT of the picture BELOW THE TUNNEL FLOOR, runs to the
   right through the earth, and where it reaches the tooth IT CURVES UP AND FOLLOWS THE TOOTH'S
   UNDERSIDE VERY CLOSELY - hugging the contour of the crown and then of both roots with only a
   thin sliver of soil between pipe and tooth - and then continues to the right and OUT OF THE
   PICTURE at the right-hand edge. IT NEVER ENTERS THE TOOTH: it does not pass through it, does
   not disappear inside it, does not touch it; it traces around the outside of it. ALONG ITS
   LENGTH, PLANTED IN THE SOIL BESIDE IT, STAND THREE SMALL WARNING PLATES: each is a simple
   YELLOW TRIANGLE with a BLACK ZIGZAG LIGHTNING BOLT inside it on a short grey stake, ABOUT AS
   TALL AS A PERSON'S HAND, and each plate carries NO WRITING WHATSOEVER - the lightning symbol
   alone says high voltage, keep away. The pipe itself is calm and pretty: NOT red, NOT flashing,
   NOT crackling with sparks.

6. THE MACHINE IS A BIG WHITE HAND-HELD TUNNEL SHIELD, THE COLOUR OF A REAL TUNNEL-BORING
   MACHINE. From front to back along one straight horizontal axis: (a) A LARGE FLAT ROUND CUTTER
   FACE, WIDER THAN THE SURGEON'S SHOULDERS and about a third of the picture height across, its
   face carrying a grid of about twenty small round disc cutters in two or three concentric rings
   plus a few radial spokes (#6f6878) and three or four slim curved slots, with a ring of soft
   violet light (#b48fc0) glowing around its rim; (b) A SHORT THICK CYLINDRICAL SHIELD OF THE
   SAME BIG DIAMETER; (c) TWO SHORT HYDRAULIC RAMS pushing it forward; (d) a slimmer BODY with a
   FRONT GRIP in her leading hand and a REAR GRIP in her other hand; (e) A VERY THICK RIBBED
   HYDRAULIC HOSE leaving the back. THE SHELL IS OFF-WHITE WITH A FAINT WARM SAND TINT (#e6e3dc),
   shaded #c4c0b6 with darker #a09a8e in the deepest folds - the clean white-grey of an industrial
   tunnel-boring machine, NOT lilac, NOT pastel, NOT flat pure white: plenty of straight panel
   seams, rows of small bolt heads and clear shading. It is an engineering tool, never a weapon:
   no muzzle, no flash, no bullets, no ammunition belt, no rivets, no boiler, no chimney, no
   smoke, and never a hollow tube opening towards the viewer.
...
7. THE HOSE IS FAT AND RUNS RIGHT OUT OF THE PICTURE, AND THE ASSISTANT IS DELIGHTED. The ribbed
   ...
   and pale grey-violet scrubs and NO MASK, ABOUT 55% OF THE PICTURE HEIGHT, THREE-QUARTER VIEW
   FACING RIGHT: both hands wrapped around the thick hose with one heavy loop over the shoulder,
   one foot forward, body leaning back against its weight, HEAD UP, MOUTH OPEN IN A WIDE HAPPY
   GRIN, eyes wide, eyebrows high.

8. THE PATIENT IS A YOUNG MAN IN HIS TWENTIES AND HE HAS BROUGHT A FRIEND - THE LAST VERSION MADE
   HIM FAR TOO OLD AND TOO STILL. At the left of the picture, both standing on the same floor in
   a warm pool of lamplight, THREE-QUARTER VIEW FACING RIGHT, drawn from the provided character
   reference for the young man:
   THE PATIENT, about twenty-five, short dark hair, A WARM OCHRE SWEATSHIRT and blue jeans and
   trainers, ABOUT 52% OF THE PICTURE HEIGHT, ONE ARM THROWN UP AND POINTING STRAIGHT AT THE
   EXPOSED CROWN, the other fist raised beside his chest, BODY LEANING FORWARD, ONE HEEL LIFTED
   MID-STEP, mouth wide open in a big round shout of delight, eyebrows high, eyes bright, with
   two or three short ink strokes beside his raised arm to show the movement;
   HIS FRIEND, the same age, a young woman with a high ponytail in a soft teal jacket and dark
   trousers, ABOUT 50% OF THE PICTURE HEIGHT, standing right beside him, ONE HAND ON HIS UPPER
   ARM and the other hand raised open beside her face, laughing and looking where he points.
   Neither of them is anxious, holding a cheek, wearing a hard hat, or looking at the viewer.
   THEY ARE THE LIVELIEST PART OF THE PICTURE.

COLOUR AND LIGHT. Warm lamplight from the two ceiling lamps; the brightest thing in the picture
is the newly uncovered crown. Lining pale lilac-grey; machine off-white; earth warm pale brown
(#c8ab86, shaded #a5855f and #8d7250) in three clear flat steps with strata lines, pebbles and
root hairs; boulders cooler grey-brown; ceramic pipe and clay jar warm terracotta; tooth
cream-white; the patient's sweatshirt warm ochre; his friend's jacket soft teal. Most colour
blocks sit around HSL saturation 30-50 and lightness 70-85. No large flat empty areas except the
calm crown band; no dusk, no orange cast, no black shadows.

COMPOSITION ANCHORS: lilac crown band across the top, tunnel floor across the bottom; the young
patient and his friend at the left in lamplight with the fat hose running out past them off the
left edge; the assistant at the centre hauling that hose; the surgeon just right of centre facing
right, her cap about a third of the way down the picture; the big white shield at the right, its
cutter face against the exposed crown; the tooth lying flat and horizontal from there to the
right edge, only its crown uncovered, the rest dashed under solid soil; the glowing nerve pipe
entering low at the left, hugging the underside of the tooth and its roots, and leaving at the
right edge with its three small lightning-symbol warning plates; boulders, old ceramic pipe, tree
root and clay jar in the earth above, below and right of the tunnel; everything that must be read
sits inside the middle 73% of the width.

AVOID: any text, letters, words, numbers, labels or written sound effects anywhere in the image;
any writing on the warning plates; face masks on anybody; an elderly patient; a lone patient with
nobody accompanying him; a view down the bore of the tunnel; one-point perspective; anybody seen
from the front or from behind; tiny distant figures; a tooth standing upright; a tooth with its
roots pointing down; a tooth with a face; an open cavity, hollow or dark void around the buried
tooth; the nerve pipe entering, crossing or vanishing inside the tooth; boulders, roots, jars or
...
machine with no seams; sky, clouds, grass, daylight; earth or neutral grey in the top band;
muzzle flash, bullets, cartridges, ammunition belts, military uniforms, camouflage, soldiers;
rivets, boilers, chimneys, smoke, steam, brass, spoked wheels, exposed gears, chains, steampunk
machinery; dental pliers, forceps, syringes, needles, scalpels, dental drills, trays of
instruments, operating theatres; hard hats, high-visibility vests, hazard tape; treasure chests,
gold coins, jewels, glitter, stars, sparkles, confetti; blood, wounds, pain, fear, cracks, decay,
stains; a mouth seen from inside; gums, jawbones, labelled anatomy, X-ray films; patterned or
printed caps; a cap that hides all of the surgeon's hair; anybody looking at the viewer; ANY
PERSON drawn faded, translucent, ghostly or outline-only (the dashed treatment is ONLY for the
buried part of the tooth); panels, insets, frames, borders, speech bubbles, arrows, small icons;
large flat empty areas; dusk, sunset, golden hour, an orange or sepia cast; photorealism; 3D
rendering; heavy even black outlines.
```

⚠ **餵圖清單（這一輪五張）**
① `drafts/surg-doctor-ref.jpg`（站上〈拔智齒之後〉裁出來的**短髮女醫師**）——
  「參考**長相、髮型、年紀、線條與臉的畫法**；**不要**參考她的坐姿、綠色刷手服與診間」。
② `drafts/surg-patient-ref.jpg`（同一張裁出來的**年輕男病人**）——
  「參考**年紀、髮型、赭黃上衣**；**不要**參考他捂著臉頰的動作與表情（這一次他是開心的）」。
③ 第七輪的生成圖 ——「參考**鏡頭、隧道、白色機器、線與配色**；
  **牙齒要真的被土蓋住、口罩拿掉、病人換年輕人、管線改成貼著牙齒走**」。
④ 白色 TBM 照片 ——「參考**白／灰的機殼與刀盤上滾刀的排列**」。
⑤ 高壓電告示牌 ——「**只參考黃三角＋黑閃電這個符號的意思**；
  **絕對不要**參考上面的任何文字（這張圖上一個字都不能有）」。

---

## 二十一、第九輪：把 Ⓐ 的人物和 Ⓑ 的四件合起來（2026-08-25）

第八輪生了兩張，使用者逐項比對之後說得很清楚：

> ・「我比較喜歡**短髮醫師那張圖裡面人物的樣子**。」（＝ Ⓐ 的卡司）
> ・「另外一張做得比較好的是**那個高壓電牌，他掛了很多個，一路掛到右邊去**，
>   　我覺得這樣非常好，代表這個是高壓電線、要注意。」
> ・「Ⓑ 還有個重點：**那個前盾跟牙齒是比較分開來的**，
>   　所以**牙齒上露出來的那個樣子比較明顯**。」
> ・「那個**紫色的電線這張圖也畫得比較好** —— 它是**在牙齒周圍、比較靠近牙齒**，
>   　然後**消失在畫面的右邊**。」
> ・「**牙齒也是很大一部分埋在土裡，Ⓑ 有畫出來，短髮醫師那個版本裡面沒有。**」

### 兩張的實測

| | Ⓐ 短髮醫師版（人物取這張） | Ⓑ 掛滿電牌版（四件取這張） | 門檻 |
| --- | --- | --- | --- |
| 邊緣密度 | 29.9%（差 0.1） | **35.2% ✓** | ≥ 30% |
| 無彩空白 | 0.5% ✓ | 0.3% ✓ | < 5% |
| 頂 17% 中位 RGB | 207/198/215 ✓ | 208/199/215 ✓ | 藍 ≥ 178 |
| 頂 17% 被佔到 | 第 127 列 ✓ | 第 127 列 ✓ | 0 |
| 圖上有沒有字 | 無 ✓（`OH!` 修掉了） | 無 ✓ | 0 |

⚠ **Ⓑ 密度高出 5.3 個百分點，來源正好是使用者喜歡的那兩件**：一路掛到右邊的電牌、
以及被土蓋住、有紋理的那半顆牙。**這一輪第三次出現「他要的東西剛好也把數字補上來」** ——
可以當成通則：**這一站的密度不足，多半不是線畫得不夠細，是畫面裡「該有的東西」還沒到齊。**

### 這一輪要合的四件（Ⓐ 的卡司 ＋ Ⓑ 的這四件）

1. **電牌從左緣一路掛到右緣**，八到十面，包含貼著牙齒那一段。
2. **前盾與牙齒之間留一段沒挖開的土**（約盾直徑的一半），
   讓露出來的牙冠**完整可見、不被機器壓到**。
3. **神經管貼著牙齒外緣走**，然後出右緣。
4. **牙齒四分之三真的被土蓋住**：土的紋理畫在它上面，虛線只是透出來。

（完整提示詞見下一節。）

---

## 二十二、第九輪的完整提示詞（2026-08-25，全新生成，可直接複製）
...
NOTHING IN THIS BRIEF MAY BE WRITTEN INTO THE PICTURE. No labels, no captions, no words, no
letters, no numbers, no exclamations, no sound effects, in any language - not on the walls, not
on the warning plates, not beside anybody's mouth. Draw feelings with faces and bodies, never
...
THE STORY IN ONE SENTENCE - THIS IS A TREASURE FIND, AND THAT IS THE WHOLE MOOD: deep underground
in a big reinforced tunnel, A WOMAN ORAL SURGEON with short hair, a violet surgical cap, a white
coat and scrubs has driven A BIG WHITE HAND-HELD TUNNEL SHIELD up to the last stretch of soil,
and THE CROWN OF AN ENORMOUS TOOTH HAS JUST APPEARED IN THE GROUND AHEAD OF HER - the tooth lies
horizontally with three quarters of it still packed under solid earth - while a GLOWING VIOLET
HIGH-VOLTAGE NERVE PIPE, hung with warning plates all along its length, curves up to skim right
past the tooth and runs away off the right-hand edge. Her assistant hauls the very thick
hydraulic hose behind her, and A YOUNG PATIENT IN HIS TWENTIES WITH A FRIEND OF THE SAME AGE have
lit up with excitement: there it is. Everybody is happy and lively. It is the moment of FINDING,
not of fighting.
...
strata ABOVE the lined crown, BELOW the tunnel floor, and in the unexcavated ground at the
RIGHT-HAND END, embed SEVERAL BIG ROUNDED BOULDERS, A THICK OLD CERAMIC PIPE running diagonally,
A FAT WOODY TREE ROOT with smaller roots branching off it, TWO HALF-BURIED ROUND CLAY JARS, and a
scatter of smaller stones and root hairs. The lined tunnel VISIBLY DIPS AND BENDS to slip between
them, just missing each one. NONE of these objects is inside the tunnel and nothing touches them.
...
1. STYLE. Thin hand-drawn linework whose weight varies and sometimes breaks - NOT a thick even
   ...
   outline, two eyes drawn as small simple dots, two short eyebrows, a tiny nose mark, a small
   mouth and an ear - no wrinkles, no cheek lines. Hair is a flat shape in two tones. EVERY
   PERSON IS DRAWN WITH EXACTLY THE SAME LINE WEIGHT AND SOLIDITY. The four people look clearly
   different: different age, build, hair and clothes. Flat fills in two or three steps per colour,
   no gradients except to describe light. Fine paper grain over the whole image.
...
3. THE SURGEON IS A WOMAN WITH SHORT HAIR, DRAWN FROM THE PROVIDED CHARACTER REFERENCE. A woman
   ...
   to her body. HER HAIR IS A SHORT DARK-BROWN BOB that ends at the jaw, with a soft fringe, and
   THE VIOLET CAP IS WORN PUSHED BACK ON HER HEAD so the fringe and the ends of the bob show
   clearly in front of it and below it - a soft tie-back surgical cap, PLAIN, WITH NO PATTERN, in
   muted violet (#8e6299, shaded #784e84). She wears AN OPEN WHITE COAT over pale grey-violet
   scrubs (#c9bcd0). SHE IS SMILING WITH DELIGHT: mouth curved up and open a little, eyes creased
   into two happy upward curves, eyebrows raised. She is about 62% of the picture height, strong
   and in control, NOT straining painfully, NOT looking at the viewer.

4. THE MACHINE STOPS SHORT OF THE TOOTH - LEAVE A CLEAR GAP BETWEEN THEM. THIS IS IMPORTANT: the
   big round cutter face must NOT touch, overlap or hide any part of the tooth. Between the front
   of the shield and the exposed crown there is A CLEAR OPEN GAP OF UNDUG BROWN EARTH about half
   the width of the shield, so the whole uncovered crown stands free and completely visible with
   nothing in front of it. The machine is still running - a few loose crumbs and two or three
   short curved motion strokes at its face - but it is plainly a step away from the find.
   THE MACHINE ITSELF, from front to back along one straight horizontal axis: (a) A LARGE FLAT
   ROUND CUTTER FACE, WIDER THAN THE SURGEON'S SHOULDERS and about a third of the picture height
   across, its face carrying a grid of about twenty small round disc cutters in two or three
   concentric rings plus a few radial spokes (#6f6878) and three or four slim curved slots, with
   a ring of soft violet light (#b48fc0) glowing around its rim; (b) A SHORT THICK CYLINDRICAL
   SHIELD OF THE SAME BIG DIAMETER; (c) TWO SHORT HYDRAULIC RAMS pushing it forward; (d) a
   slimmer BODY with a FRONT GRIP in her leading hand and a REAR GRIP in her other hand; (e) A
   VERY THICK RIBBED HYDRAULIC HOSE leaving the back. THE SHELL IS OFF-WHITE WITH A FAINT WARM
   SAND TINT (#e6e3dc), shaded #c4c0b6 with darker #a09a8e in the deepest folds - the clean
   white-grey of an industrial tunnel-boring machine, NOT lilac, NOT pastel, NOT flat pure white:
   plenty of straight panel seams, rows of small bolt heads and clear shading. It is an
   engineering tool, never a weapon.

5. THE GIANT TOOTH LIES FLAT AND IS PACKED UNDER SOLID EARTH. ITS LONG AXIS IS HORIZONTAL,
   PARALLEL TO THE TUNNEL FLOOR - lying like a fallen pillar, NOT upright, NOT tilted. THE CROWN
   END POINTS LEFT towards the machine; THE TWO THICK ROOTS POINT RIGHT, sticking out
   horizontally towards the right edge, never downwards. ONLY THE CROWN - the left-hand quarter -
   IS EXPOSED, drawn SOLID CREAM-WHITE (#f2ece2, shaded #d9cfc0), bright and clean, with three or
   four short straight light strokes radiating from it. THE OTHER THREE QUARTERS ARE COMPLETELY
   COVERED BY EARTH AND THE EARTH IS DRAWN ON TOP OF THEM: the same brown soil with its own
   strata lines, pebbles, speckles and root hairs runs right across that part of the tooth, so it
   is obviously still underground. There is NO cavity, NO air gap, NO open chamber and NO dark
   void anywhere around it. The buried three quarters are indicated ONLY by a DASHED OR DOTTED
   OUTLINE showing faintly through that soil, like an excavation survey drawing. Laid out flat
   the whole tooth is LONGER THAN THE SURGEON IS TALL, spanning most of the right-hand half of
   the picture, its body about 45% of the picture height thick. IT HAS NO FACE.

6. THE HIGH-VOLTAGE NERVE PIPE HUGS THE TOOTH AND IS SIGNPOSTED ALL THE WAY ACROSS. A smooth
   rounded pipe filled with gently glowing pale violet light (#b48fc0 with a lighter #d6bfdd
   core) enters at the LEFT EDGE of the picture below the tunnel floor, runs right through the
   earth, and where it reaches the tooth IT CURVES UP AND FOLLOWS THE TOOTH'S OUTLINE VERY
   CLOSELY - skimming along the underside of the crown and then around both roots with only a
   thin sliver of soil between pipe and tooth - then continues on and LEAVES THE PICTURE AT THE
   RIGHT-HAND EDGE. IT NEVER ENTERS THE TOOTH: it does not pass through it and does not touch it;
   it traces around the outside. ALL ALONG THE PIPE, FROM THE LEFT EDGE TO THE RIGHT EDGE, PLANT
   ...
   EACH PLATE CARRIES NO WRITING WHATSOEVER - the row of lightning symbols alone says high
   voltage, keep clear. The pipe itself stays calm and pretty: NOT red, NOT flashing, NOT
...
8. THE PATIENT IS A YOUNG MAN IN HIS TWENTIES AND HE HAS BROUGHT A FRIEND. At the left of the
   picture, both standing on the same floor in a warm pool of lamplight, THREE-QUARTER VIEW
   FACING RIGHT, the young man drawn from the provided character reference:
   THE PATIENT, about twenty-five, short dark hair, A WARM OCHRE SWEATSHIRT, blue jeans and
   trainers, ABOUT 52% OF THE PICTURE HEIGHT, ONE ARM THROWN UP AND POINTING STRAIGHT AT THE
   EXPOSED CROWN, the other fist raised beside his chest, BODY LEANING FORWARD, ONE HEEL LIFTED
   MID-STEP, mouth wide open in a big round shout of delight, eyebrows high, eyes bright, with
   two or three short ink strokes beside his raised arm to show the movement;
   ...
   trousers, ABOUT 50% OF THE PICTURE HEIGHT, standing right beside him, ONE HAND ON HIS UPPER
   ARM and the other hand raised open beside her face, laughing and looking where he points.
   Neither is anxious, holding a cheek, wearing a hard hat, or looking at the viewer. THEY ARE
   THE LIVELIEST PART OF THE PICTURE.

COLOUR AND LIGHT. Warm lamplight from the two ceiling lamps; the brightest thing in the picture
is the newly uncovered crown. Lining pale lilac-grey; machine off-white; earth warm pale brown
(#c8ab86, shaded #a5855f and #8d7250) in three clear flat steps with strata lines, pebbles and
root hairs; boulders cooler grey-brown; ceramic pipe and clay jars warm terracotta; tooth
cream-white; the patient's sweatshirt warm ochre; his friend's jacket soft teal; the warning
plates warm yellow. Most colour blocks sit around HSL saturation 30-50 and lightness 70-85. No
large flat empty areas except the calm crown band; no dusk, no orange cast, no black shadows.

COMPOSITION ANCHORS: lilac crown band across the top, tunnel floor across the bottom; the young
patient and his friend at the left in lamplight with the fat hose running out past them off the
left edge; the assistant at the centre hauling that hose; the surgeon just right of centre facing
right, her cap about a third of the way down the picture; the white shield ahead of her with an
open gap of earth between its cutter face and the tooth; the exposed crown standing clear in that
gap; the rest of the tooth lying flat to the right under solid soil, dashed; the glowing nerve
pipe entering low at the left, curving up around the crown and roots and leaving at the right
edge, with eight to ten lightning-symbol plates spaced along its whole length; boulders, old
ceramic pipe, tree root and clay jars in the earth above, below and right of the tunnel;
everything that must be read sits inside the middle 73% of the width.

AVOID: any text, letters, words, numbers, labels or written sound effects anywhere; any writing
on the warning plates; face masks on anybody; an elderly patient; a lone patient with nobody
...
the tooth; a tooth standing upright; a tooth with its roots pointing down; a tooth with a face;
an open cavity, hollow or dark void around the buried tooth; a buried part left as bare outline
with no soil drawn over it; the nerve pipe entering, crossing or vanishing inside the tooth; a
nerve pipe with only one or two warning plates; boulders, roots, jars or debris inside the
tunnel; a wheeled trolley or generator on the tunnel floor; a thin hose; a front end made of
several thin barrels; a lilac or pastel machine shell; a flat pure white machine with no seams;
sky, clouds, grass, daylight; earth or neutral grey in the top band; muzzle flash, bullets,
cartridges, ammunition belts, military uniforms, camouflage, soldiers; rivets, boilers, chimneys,
smoke, steam, brass, spoked wheels, exposed gears, chains, steampunk machinery; dental pliers,
forceps, syringes, needles, scalpels, dental drills, trays of instruments, operating theatres;
hard hats, high-visibility vests, hazard tape; treasure chests, gold coins, jewels, glitter,
stars, sparkles, confetti; blood, wounds, pain, fear, cracks, decay, stains; a mouth seen from
inside; gums, jawbones, labelled anatomy, X-ray films; patterned or printed caps; a cap that
hides all of the surgeon's hair; anybody looking at the viewer; ANY PERSON drawn faded,
translucent, ghostly or outline-only (the dashed treatment is ONLY for the buried part of the
tooth); panels, insets, frames, borders, speech bubbles, arrows, small icons; large flat empty
areas; dusk, sunset, golden hour, an orange or sepia cast; photorealism; 3D rendering; heavy even
black outlines.
```

⚠ **餵圖（六張，用途分開寫）**：
① `drafts/surg-doctor-ref.jpg` ②`drafts/surg-patient-ref.jpg`（同上一輪）
③ **第八輪的 Ⓐ 短髮醫師版** ——「**人物、臉、髮型、服裝、鏡頭與配色照這一張**」
④ **第八輪的 Ⓑ 掛滿電牌版** ——「**只**參考四件：**電牌一路掛到右邊**、
   **前盾與牙齒之間留一段土**、**電線貼著牙齒外緣走並出右緣**、
...
## 二十五、第十一輪：風格掉下來了、油壓管和電線接在一起（2026-08-25）

使用者：「**風格跑掉了**，而且**潛盾的管線和電線接在一起，好怪**。」

### 實測 —— 「風格跑掉」是量得出來的

| | 第九輪（風格對） | 第十輪（風格掉了） | 門檻 |
| --- | --- | --- | --- |
| 邊緣密度 | 38.2% | **28.8%（−9.4）** | ≥ 30% |
| 無彩空白 | 1.3% | **3.2%（×2.5）** | < 5% |
| 頂 17% 中位 RGB | 土色 ✗ | 204/195/212 ✓ | 藍 ≥ 178 |
| 圖上有沒有字 | 五處 ✗ | **0 ✓**（改成正常大小寫奏效） | 0 |

⚠ **「風格跑掉」不是感覺，是密度掉了 9.4 個百分點**：襯砌的環片、螺栓、鋼肋不見了，
左半邊變成一面幾乎沒有東西的淡紫牆，土只剩右邊一角。
**改成正常大小寫解決了英文字，但同時把所有的強調都拿掉了**，模型於是把細節一起省了。
→ 這一輪的做法：**不要把強調加回去（那會再長出字），改成把「要畫什麼」寫得更具體**
（環片每隔多遠一道、螺栓幾顆、土分三階…），並**指名以第八輪 Ⓐ 那張為風格基準**。

### 油壓管和電線為什麼會接在一起

看圖就知道：**那條發光電線被畫進隧道裡了**，沿著地板走，於是它和沿地板拖行的油壓管
變成同一條線的兩段。成因是我寫「電線在地板下方」，但**沒有給地板一個位置**，
畫面裡地板幾乎貼著下緣，土層根本沒有空間。

→ 這一輪把幾何寫死：**地板線落在畫面往下三分之二處**，**下面三分之一是剖開的土**，
電線走在那片土裡；**油壓管永遠在隧道內、地板以上**，從左緣出去；
**兩者之間永遠看得到一條土**，不接、不交叉、不並排。

（完整提示詞見下一節。）

---

## 二十六、第十一輪的完整提示詞（2026-08-25，全新生成）
...
Very important: the finished picture contains no writing at all. No labels, no captions, no
titles, no letters, no numbers, no sound effects, in any language, anywhere - not on the walls,
not on the warning plates, not beside anybody's mouth, not in the corners. Every word in this
brief is an instruction to you, never something to draw. If you feel tempted to label a part of
the picture, draw it more clearly instead.

Style anchor: match the supplied reference illustration of this same scene exactly - the same
thin hand-drawn ink line, the same colour saturation, and above all the same density of drawn
detail. The last attempt came out too empty and too pale: the concrete lining lost its rings and
bolts, half the picture became a bare lilac wall, and the earth almost disappeared. Every surface
in this picture carries drawn detail: the lining has a joint line every so often, a row of small
round bolt heads along each joint and a steel rib arch standing proud every few metres; the earth
is drawn in three clearly different browns with strata lines, many small pebbles of two or three
sizes, speckles and fine root hairs throughout; the machine has panel seams and bolt rows. Apart
from the calm band at the top, no patch bigger than about a tenth of the picture is flat empty
colour.

Camera: we look at a tunnel from the side, as if the near wall had been cut away. The lined crown
of the tunnel runs across the top of the picture; the tunnel floor is a horizontal line about two
thirds of the way down the picture; below that floor line, the bottom third of the image is
cutaway earth, seen in section; the far wall stands behind the people; and more cutaway earth
fills the right-hand end where the tunnel has not been dug yet. Every person is seen in full side
view or three-quarter view, facing right, standing on the same floor line, so every posture and
face is large and easy to read. We are not looking down the bore of the tunnel: no vanishing
...
and scrubs has driven a big white hand-held tunnel shield up to the last stretch of soil, and the
tip of an enormous tooth has just appeared in the ground ahead of her. The tooth lies flat and
three quarters of it are still packed under solid earth. Deep under the tunnel floor, a glowing
violet high-voltage cable, hung with small warning plates all along its length, curves up through
the earth to skim past the tooth and runs away off the right-hand edge. Her assistant hauls the
very thick hydraulic hose behind her, and a young patient in his twenties with a friend of the
same age have lit up with excitement: there it is. Everybody is happy and lively. It is the
moment of finding, not of fighting.

The whole picture is underground. There is no sky, no grass, no view of the ground surface and no
daylight opening.

The tunnel is big enough to walk through. Its crown and far wall are lined with curved concrete
segment panels in pale lilac-grey (#d3cbdd, shaded #b3a9c2). The floor is packed earth with a
scatter of small pebbles. Two small ceiling lamps hang from the crown and throw warm pools of
light onto the people. Inside the tunnel everything is clear and tidy: apart from the people, the
machine and the hose, nothing is lying about in it.
...
faint horizontal joint lines and nothing else. That band must be clearly lilac-tinted, never a
neutral grey, never near-white, never brown. Nothing may cross into it: no head, no cap, no
raised hand, no tooth, no lamp, no lamp chain, no rock. Compose so that every head, every lamp
and the top of the tooth sit below a line one fifth of the way down from the top, about 126
pixels of the 628.

Two long things run across this picture and they must never be confused with each other. The
first is the hydraulic hose: it is ribbed, dull grey-brown, as thick as a person's thigh, and it
belongs inside the tunnel. It leaves the back of the machine, sweeps down past the surgeon's
legs, passes through the assistant's two hands, lies along the tunnel floor and runs off the
left-hand edge of the picture. It never dips below the floor line and it never glows. The second
is the glowing violet high-voltage cable, and it belongs in the earth beneath the tunnel. It
enters at the left edge well below the floor line, runs to the right through the cutaway soil,
and only where it reaches the tooth does it rise, still inside the earth, to skim around the
tooth before leaving at the right-hand edge. It never comes up into the tunnel, never touches the
floor, never touches the hose and never joins, crosses or runs alongside it. Between the hose and
the cable there is always a clearly visible band of drawn soil, so a viewer can never read them
as one connected line.

The rough, awkward things that had to be avoided sit in that cutaway earth, below the floor line
...
1. Line and faces. Thin hand-drawn linework whose weight varies and sometimes breaks - not a
   thick even outline, not a ruled vector line. Each face is one flat skin tone with no shading:
   only the outline, two eyes drawn as small simple dots, two short eyebrows, a tiny nose mark, a
   small mouth and an ear; no wrinkles, no cheek lines. Hair is a flat shape in two tones. Every
   person is drawn with exactly the same line weight and solidity. The four people look clearly
   different from each other in age, build, hair and clothes. Flat fills in two or three steps
   per colour, no gradients except to describe light. Fine paper grain over the whole image.
...
4. The machine stops short of the tooth, and there is a clear gap between them. The big round
   ...
   thick cylindrical shield of the same big diameter; then two short hydraulic rams pushing it
   forward; then a slimmer body with a front grip in her leading hand and a rear grip in her
   other hand; and the thick ribbed hose leaving the back. The shell is off-white with a faint
   warm sand tint (#e6e3dc), shaded #c4c0b6 with darker #a09a8e in the deepest folds: the clean
   white-grey of an industrial tunnel-boring machine, not lilac, not pastel, not flat pure white,
   with plenty of straight panel seams, rows of small bolt heads and clear shading. It is an
   engineering tool, never a weapon.

5. The giant tooth lies flat and is mostly still buried; think of a shipwreck half sunk in sand.
   Its long axis is horizontal, parallel to the tunnel floor, lying like a fallen pillar; it is
   not upright and not tilted. Its crown end points left, towards the machine, and its two thick
   roots point right, horizontally, towards the right edge of the picture; the roots never point
   downwards. Draw a wavy edge of soil crossing the tooth about a quarter of the way along its
   length, running from its top surface down to its bottom surface. To the left of that soil
   edge, the tooth is drawn solid and clean in cream white (#f2ece2, shaded #d9cfc0), bright in
   the lamplight, with three or four short straight light strokes radiating from it. To the right
   of that soil edge there is only brown soil: the same earth colour, with its own strata lines,
   pebbles, speckles and root hairs drawn right across it, and the soil clearly overlaps the edge
   of the tooth so it is obviously lying on top of it. In that buried stretch the tooth appears
   only as a faint dotted outline showing through the soil, like an excavation survey drawing -
   never clean white, never a solid shape, never inside an open hollow or dark cavity, never with
   an air gap around it. Laid out flat the whole tooth is longer than the surgeon is tall,
   spanning most of the right-hand half of the picture, and its body is about 45% of the picture
   height thick. It has no face.

6. The glowing cable is signposted all the way across. Along it, from the left edge of the
   picture to the right edge, plant eight to ten small warning plates in the soil beside it,
   evenly spaced, including on the stretch that curves around the tooth. Each plate is a simple
   yellow triangle with a black zigzag lightning bolt inside it, on a short grey stake about as
   tall as a person's hand, and each plate is blank apart from that lightning symbol - no writing
   of any kind on them. The cable itself stays calm and pretty: a smooth rounded tube of gently
   glowing pale violet light (#b48fc0 with a lighter #d6bfdd core), not red, not flashing, not
   crackling with sparks. It skims around the outside of the tooth, close to it, but never enters
   it and never touches it.

7. The assistant is delighted. At the centre of the picture, in their twenties, in a violet cap
   and pale grey-violet scrubs and no mask, about 55% of the picture height, in three-quarter
   view facing right: both hands wrapped around the thick hose with one heavy loop over the
   shoulder, one foot forward, body leaning back against its weight, head up, mouth open in a
   wide happy grin, eyes wide, eyebrows high. There is no wheeled unit, trolley or generator
...
picture is the newly uncovered tip of the tooth. The lining is pale lilac-grey; the machine is
off-white; the earth is warm pale brown (#c8ab86, shaded #a5855f and #8d7250) in three clear flat
steps; the boulders are a cooler grey-brown; the ceramic pipe and the clay jars are warm
terracotta; the tooth is cream white; the patient's sweatshirt is warm ochre; his friend's jacket
is soft teal; the warning plates are warm yellow; the hose is dull grey-brown. Most colour blocks
sit around HSL saturation 30-50 and lightness 70-85. No dusk, no orange cast, no black shadows.

Composition anchors: the lilac lining band runs across the very top with nothing above it; the
tunnel floor line runs across at about two thirds of the height; the bottom third of the picture
is cutaway earth with the glowing cable and its warning plates running through it; the young
patient and his friend stand at the left inside the tunnel with the ribbed hose running out past
them off the left edge, well above the cable; the assistant is at the centre hauling that hose;
the surgeon is just right of centre facing right, her cap about a third of the way down the
picture; the white shield is ahead of her with an open gap of earth between its cutter face and
the tooth; the exposed tip of the tooth stands clear in that gap; the rest of the tooth lies flat
to the right underneath solid drawn soil, showing only as a dotted outline; boulders, the old
ceramic pipe, the root and the clay jars sit in the earth below the floor and at the right-hand
end; everything that must be read sits inside the middle 73% of the width.

Avoid: any writing, letters, words, numbers, labels or captions anywhere in the image; any
writing on the warning plates; a strip of soil, rocks or roots along the top edge above the
lining; a bare, flat, undetailed lining with no joints, bolts or rib arches; a picture that looks
pale, empty or unfinished compared with the reference; the hydraulic hose dipping below the floor
line; the glowing cable coming up into the tunnel or lying on the tunnel floor; the hose and the
cable touching, joining, crossing or running side by side; a hose that glows; face masks on
anybody; an elderly patient; a lone patient with nobody accompanying him; a view down the bore of
the tunnel; one-point perspective; anybody seen from the front or from behind; tiny distant
figures; the cutter face touching, overlapping or hiding the tooth; a tooth standing upright; a
tooth with its roots pointing down; a tooth with a face; a whole clean tooth fully out of the
ground; a buried stretch drawn in clean white instead of soil; an open cavity or dark void around
the tooth; the cable entering or crossing inside the tooth; a cable with only one or two warning
plates; boulders, roots, jars or debris inside the tunnel; a wheeled trolley or generator on the
floor; a thin hose; a front end made of several thin barrels; a lilac or pastel machine shell; a
flat pure white machine with no seams; sky, clouds, grass, daylight; muzzle flash, bullets,
cartridges, ammunition belts, military uniforms, camouflage, soldiers; rivets, boilers, chimneys,
smoke, steam, brass, spoked wheels, exposed gears, chains, steampunk machinery; dental pliers,
forceps, syringes, needles, scalpels, dental drills, trays of instruments, operating theatres;
hard hats, high-visibility vests, hazard tape; treasure chests, gold coins, jewels, glitter,
...
inside; gums, jawbones, labelled anatomy, X-ray films; patterned or printed caps; a cap that
hides all of the surgeon's hair; anybody looking at the viewer; any person drawn faded,
translucent, ghostly or outline-only, since the dotted treatment belongs only to the buried part
of the tooth; panels, insets, frames, borders, speech bubbles, arrows, small icons; large flat
empty areas; dusk, sunset, golden hour, an orange or sepia cast; photorealism; 3D rendering;
heavy even black outlines.
```

⚠ **餵圖這一輪把「風格基準」擺第一**：第八輪的 Ⓐ 短髮醫師版 ——
「**線的粗細、顏色、細節的密度、人物與鏡頭全部照這一張**」；其餘照舊
（短髮女醫師、年輕病人、Ⓑ 的四件、白色 TBM、高壓電符號）。

---

## 二十七、第十二輪：刀盤裝反了、露出的那一截不像牙齒（2026-08-25）

使用者：「**那個刀盤反了**，它現在**插在刀盤上**，這樣不對啊。另外**那個牙齒凸出來的地方
看起來很不像牙齒**，露出的地方很不像牙齒，**牙齒變好小，應該再大一點**。」
...
| 邊緣密度 | **40.2% ✓✓ 歷來最高** | ≥ 30% |
| 無彩空白 | **9.8% ✗**（上一輪 3.2%） | < 5% |
| 頂 17% 中位 RGB | 208/201/217 ✓ | 藍 ≥ 178 |
| 頂 17% 被佔到 | 第 111 列 ✓ | 0 |
| 圖上有沒有字 | 0 ✓ | 0 |

⚠ **空白爬到 9.8%**：襯砌畫得又大又亮、白機器變大、白袍也白 —— 三塊淺色加起來就破表。
這一輪的修法**不是把襯砌改小**（那會又掉密度），是**把它畫深一階並加陰影**：
牆面下半段壓一條深一階的淡紫、每道鋼肋兩側各給一塊陰影、機殼有三分之一是中灰階。

### 兩個要修的

1. ⚠⚠ **刀盤裝反了，而且軟管接在刀盤上。** 現在的圖是：刀盤在圓筒的**左端、朝著醫師**，
   軟管直接插在刀盤中央 —— 等於機器朝著自己人挖。
   → 這一輪改用**畫面左右**寫死，不再說「前後」：
   **刀盤是整台機器最右邊的那一片，貼著右邊的土**；
   **機身往左延伸**；**握把與軟管接頭在最左端、靠近醫師**；
   **醫師站在機器左邊，把它往右推**；**刀盤上不可以接任何東西**。
   ⚠ 這是這一整輪學到的第四個「模型分不清方向」的例子
   （前三個：牙齒直立、隧道透視、雜物在裡面）——
   **凡是有方向的東西，一律用「畫面的左／右／上／下」講，不要用「前／後」。**
2. **露出的那一截要像一顆牙，而且要大。** 現在露出來的是一個尖尖的白角。
   → 寫死成：**露出來的是完整的牙冠** —— 圓潤的咬合面、上面兩三個低矮的牙尖、
   鼓起的側面、以及往下收成牙頸的那一段；**光是這個牙冠就要佔畫面高度的四成五**、
   寬度約畫面的六分之一。**不是碎片、不是楔形、不是白色的石頭尖端。**

（完整提示詞見下一節。）

---

## 二十八、第十二輪的完整提示詞（2026-08-25，全新生成）
...
Style anchor: match the supplied reference illustration of this same scene - the same thin
hand-drawn ink line, the same colour saturation and the same density of drawn detail. Every
surface carries drawn detail: the lining has joint lines, rows of small round bolt heads and a
steel rib arch every few metres; the earth is drawn in three clearly different browns with strata
lines, many small pebbles, speckles and fine root hairs; the machine has panel seams and bolt
rows. Apart from the calm band at the top, no patch bigger than about a tenth of the picture is
flat empty colour. Keep the picture from going pale: the concrete lining is a mid-tone lilac-grey
rather than a washed-out one, its lower half carries a band one step darker, each rib arch has a
shadow down both sides, and about a third of the machine's shell is in its mid-grey shade.
...
The story in one sentence, and it sets the mood - this is a treasure find: deep underground in a
big reinforced tunnel, a woman oral surgeon with short hair, a violet surgical cap, a white coat
and scrubs is pushing a big white hand-held tunnel shield towards the right, into the last
stretch of soil, and the crown of an enormous tooth has just appeared in the ground ahead of it.
The tooth lies flat and three quarters of it are still packed under solid earth. Deep under the
tunnel floor, a glowing violet high-voltage cable, hung with small warning plates all along its
length, curves up through the earth to skim past the tooth and runs away off the right-hand edge.
Her assistant hauls the very thick hydraulic hose behind her, and a young patient in his twenties
with a friend of the same age have lit up with excitement: there it is. Everybody is happy and
lively. It is the moment of finding, not of fighting.

The whole picture is underground: no sky, no grass, no view of the ground surface, no daylight
opening.

The machine faces right, and this is the thing the last version got wrong, so follow the left and
right of the picture exactly. The round cutter face is the rightmost part of the whole machine.
It stands at the right-hand end of the cylinder, pressed against the brown earth on the right,
and it faces away from everybody, towards the right edge of the picture. Behind it, that is to
say to its left, comes the short thick cylindrical shield of the same big diameter, then two
short hydraulic rams, then a slimmer body. The two grips are at the left-hand end of the machine,
nearest the surgeon, and the thick hose is connected at that same left-hand end. The surgeon
stands to the left of the machine and pushes it to the right. Nothing whatsoever is attached to
the cutter face: no hose, no cable, no grip, no hand. The cutter face is never on the left of the
machine, never points at the surgeon and is never hidden behind the body.

The cutter face itself is a large flat disc, wider than the surgeon's shoulders and about a third
of the picture height across, seen very slightly from the side so it reads as a disc. Its face
carries a grid of about twenty small round disc cutters in two or three concentric rings plus a
few radial spokes (#6f6878) and three or four slim curved slots, with a ring of soft violet light
(#b48fc0) glowing around its rim. The shell of the shield and body is off-white with a faint warm
sand tint (#e6e3dc), shaded #c4c0b6 with darker #a09a8e in the deepest folds - the clean
white-grey of an industrial tunnel-boring machine, not lilac, not pastel, not flat pure white,
with plenty of straight panel seams, rows of small bolt heads and clear shading. It is an
engineering tool, never a weapon.

The machine also stops short of the tooth: between the cutter face and the exposed crown there is
an open gap of undug brown earth about half the width of the shield, so the crown stands free
with nothing in front of it. The machine is still running: a few loose crumbs and two or three
short curved motion strokes at its face.

The tooth must look unmistakably like a tooth, and it must be big - the last version showed only
a small pointed white wedge, which is wrong. What is uncovered is the whole crown of a molar: a
rounded biting surface with two or three low cusps along the top, bulging sides that swell out
and then draw in again at the neck, and a soft groove across the biting surface. That exposed
crown alone is about 45% of the picture height tall and about one sixth of the picture width, so
it is the largest single object in the right-hand half of the picture; it is drawn solid and
clean in cream white (#f2ece2, shaded #d9cfc0), bright in the lamplight, with three or four short
straight light strokes radiating from it. It is never a shard, never a wedge, never a pointed
white stone, never a small chip.

The rest of the tooth lies flat and is still buried; think of a shipwreck half sunk in sand. Its
long axis is horizontal, parallel to the tunnel floor, lying like a fallen pillar; it is not
upright and not tilted. The crown end points left, towards the machine, and the two thick roots
point right, horizontally, towards the right edge of the picture; the roots never point
downwards. A wavy edge of soil crosses the tooth just behind the crown, running from its top
surface down to its bottom surface. To the right of that soil edge there is only brown soil: the
same earth colour, with its own strata lines, pebbles, speckles and root hairs drawn right across
it, and the soil clearly overlaps the edge of the tooth so it is obviously lying on top of it. In
that buried stretch the tooth appears only as a faint dotted outline showing through the soil,
like an excavation survey drawing - never clean white, never a solid shape, never inside an open
hollow or dark cavity, never with an air gap around it. Laid out flat the whole tooth, buried
part included, is longer than the surgeon is tall and spans most of the right-hand half of the
picture. It has no face.
...
no tooth, no lamp, no lamp chain, no rock. Compose so that every head, every lamp and the top of
the tooth sit below a line one fifth of the way down from the top, about 126 pixels of the 628.

Two long things run across this picture and they must never be confused with each other. The
hydraulic hose is ribbed, dull grey-brown, as thick as a person's thigh, and it belongs inside
the tunnel: it leaves the left-hand end of the machine, sweeps down past the surgeon's legs,
passes through the assistant's two hands, lies along the tunnel floor and runs off the left-hand
edge of the picture. It never dips below the floor line and it never glows. The glowing violet
high-voltage cable belongs in the earth beneath the tunnel: it enters at the left edge well below
the floor line, runs right through the cutaway soil, and only where it reaches the tooth does it
rise, still inside the earth, to skim around the outside of the tooth before leaving at the
right-hand edge. It never comes up into the tunnel, never touches the floor, never touches the
hose, never joins or crosses it, and never enters the tooth. Between the hose and the cable there
is always a clearly visible band of drawn soil.

Along the cable, from the left edge of the picture to the right edge, plant eight to ten small
warning plates in the soil beside it, evenly spaced, including on the stretch that curves around
the tooth. Each plate is a simple yellow triangle with a black zigzag lightning bolt inside it,
on a short grey stake about as tall as a person's hand, and each plate is blank apart from that
lightning symbol. The cable itself stays calm and pretty: a smooth rounded tube of gently glowing
pale violet light (#b48fc0 with a lighter #d6bfdd core), not red, not flashing, not crackling.
...
3. The surgeon is a woman with short hair, drawn from the character reference supplied with this
   brief. She is in her thirties or forties, seen from the side, facing right, standing just left
   of the machine, leaning her weight into it: one foot forward, one braced back, knees bent,
   both hands on the two grips at the machine's left-hand end. Her hair is a short dark-brown bob
   ending at the jaw with a soft fringe, and the violet cap is worn pushed back on her head so
   the fringe and the ends of the bob show clearly in front of it and below it. The cap is a soft
   tie-back surgical cap, plain, with no pattern, in muted violet (#8e6299, shaded #784e84). She
   wears an open white coat over pale grey-violet scrubs (#c9bcd0). She is smiling with delight:
   mouth curved up and open a little, eyes creased into two happy upward curves, eyebrows raised.
   She is about 62% of the picture height, strong and in control, not straining painfully, not
   looking at the viewer.

4. The assistant is delighted. At the centre of the picture, in their twenties, in a violet cap
   and pale grey-violet scrubs and no mask, about 55% of the picture height, in three-quarter
   view facing right: both hands wrapped around the thick hose with one heavy loop over the
   shoulder, one foot forward, body leaning back against its weight, head up, mouth open in a
   wide happy grin, eyes wide, eyebrows high. There is no wheeled unit, trolley or generator
...
5. The patient is a young man in his twenties and he has brought a friend. Both stand at the left
   of the picture on the same floor, in a warm pool of lamplight, in three-quarter view facing
   right; draw the young man from the character reference supplied with this brief. The patient
   is about twenty-five, with short dark hair, a warm ochre sweatshirt, blue jeans and trainers,
   about 52% of the picture height, one arm thrown up and pointing straight at the exposed crown,
   the other fist raised beside his chest, body leaning forward, one heel lifted mid-step, mouth
   wide open in a big round shout of delight, eyebrows high, eyes bright, with two or three short
   ink strokes beside his raised arm to show the movement. His friend is the same age, a young
   woman with a high ponytail in a soft teal jacket and dark trousers, about 50% of the picture
   height, standing right beside him with one hand on his upper arm and the other hand raised
   open beside her face, laughing and looking where he points. Neither of them is anxious,
   holding a cheek, wearing a hard hat, or looking at the viewer. They are the liveliest part of
   the picture.

Colour and light: warm lamplight from the two ceiling lamps, and the brightest thing in the
picture is the newly uncovered crown. The lining is mid-tone lilac-grey; the machine is
off-white with a third of it in shade; the earth is warm pale brown (#c8ab86, shaded #a5855f and
#8d7250) in three clear flat steps; the boulders are a cooler grey-brown; the ceramic pipe and
the clay jars are warm terracotta; the tooth is cream white; the patient's sweatshirt is warm
ochre; his friend's jacket is soft teal; the warning plates are warm yellow; the hose is dull
grey-brown. Most colour blocks sit around HSL saturation 30-50 and lightness 70-85. No dusk, no
orange cast, no black shadows.

Composition anchors: the lilac lining band runs across the very top with nothing above it; the
tunnel floor line runs across at about two thirds of the height; the bottom third is cutaway
earth with the glowing cable and its warning plates; the young patient and his friend stand at
the left inside the tunnel with the ribbed hose running out past them off the left edge, well
above the cable; the assistant is at the centre hauling that hose; the surgeon stands just right
of centre facing right with both hands on the grips at the machine's left-hand end; the machine
lies to her right with its round cutter face at its far right pressed into the earth; the big
exposed crown stands in the earth further right, with an open gap between it and the cutter face;
the buried rest of the tooth runs from there to the right edge under solid drawn soil; the
boulders, the old ceramic pipe, the root and the clay jars sit in the earth below the floor and
at the right-hand end; everything that must be read sits inside the middle 73% of the width.

Avoid: any writing, letters, words, numbers or labels anywhere; writing on the warning plates; a
cutter face on the left-hand end of the machine; a cutter face pointing towards the surgeon or
towards the viewer; a hose, cable, grip or hand attached to the cutter face; a machine pushed to
the left; a small tooth; an exposed part that reads as a wedge, a shard, a chip or a pointed
stone rather than a tooth crown; a tooth standing upright; a tooth with its roots pointing down;
a tooth with a face; a whole clean tooth fully out of the ground; a buried stretch drawn in clean
white instead of soil; an open cavity or dark void around the tooth; the cable entering or
crossing inside the tooth; the hose dipping below the floor line; the cable coming up into the
tunnel; the hose and the cable touching, joining or running side by side; a hose that glows; a
strip of soil, rocks or roots along the top edge above the lining; a bare, flat, undetailed
lining with no joints, bolts or rib arches; a pale, empty or unfinished-looking picture; face
masks on anybody; an elderly patient; a lone patient with nobody accompanying him; a view down
the bore of the tunnel; one-point perspective; anybody seen from the front or from behind; tiny
distant figures; boulders, roots, jars or debris inside the tunnel; a wheeled trolley or
generator on the floor; a thin hose; a front end made of several thin barrels; a lilac or pastel
machine shell; a flat pure white machine with no seams; sky, clouds, grass, daylight; muzzle
flash, bullets, cartridges, ammunition belts, military uniforms, camouflage, soldiers; rivets,
boilers, chimneys, smoke, steam, brass, spoked wheels, exposed gears, chains, steampunk
machinery; dental pliers, forceps, syringes, needles, scalpels, dental drills, trays of
instruments, operating theatres; hard hats, high-visibility vests, hazard tape; treasure chests,
gold coins, jewels, glitter, stars, sparkles, confetti; blood, wounds, pain, fear, cracks, decay,
stains; a mouth seen from inside; gums, jawbones, labelled anatomy, X-ray films; patterned or
printed caps; a cap that hides all of the surgeon's hair; anybody looking at the viewer; any
person drawn faded, translucent, ghostly or outline-only, since the dotted treatment belongs only
to the buried part of the tooth; panels, insets, frames, borders, speech bubbles, arrows, small
icons; large flat empty areas; dusk, sunset, golden hour, an orange or sepia cast; photorealism;
3D rendering; heavy even black outlines.
```

⚠ 餵圖同上一輪，**第一張仍然是第十一輪那張**（線與密度已經對了），
用途改寫成：「**線、顏色、密度、隧道與人物照這一張；但機器要左右相反
（刀盤在最右邊、握把與軟管在最左邊），露出來的牙冠要大得多、而且要是一顆完整的臼齒冠**」。

---

## 二十九、第十三輪：人物風格、牙齒再大兩倍半、電牌要整條都有（2026-08-25）

使用者（這一張是**沒有附任何參考圖**生的）：

> ・「第一個是**人物風格**。人物風格跟之前的不一樣，不過應該是我沒附圖 ——
>   　**你再修改提示詞**〔讓提示詞本身也把人物風格講清楚〕。」
> ・「第二個是**牙齒大小**，我覺得不太夠，**大概要這個牙齒的兩倍到兩倍半大**會比較好。
>   　但是**他畫的露出來跟埋在裡面的感覺非常不錯，我喜歡**。」
> ・「第三個是那個**紫色電線的標示牌現在都標示在右下角**，不夠多，**整條都要有標示**。」
...
| --- | --- | --- |
| 邊緣密度 | **32.2% ✓** | ≥ 30% |
| 無彩空白 | **0.3% ✓**（上一輪 9.8%，加深襯砌＋機殼上灰奏效） | < 5% |
| 頂 17% 中位 RGB | 200/191/205 ✓ | 藍 ≥ 178 |
| 頂 17% 被佔到 | 只有一條襯砌接縫（第 91 列，在帶子底下） | 0 |
| 圖上有沒有字 | 0 ✓ | 0 |
| 刀盤方向 | ✅ 修好了（最右、朝右、上面沒有接東西） | — |

### 這一輪的三個修法

1. ⚠⚠ **百分比講不動的東西，改用「和畫面裡另一個東西比」。**
   前一輪我寫「露出的牙冠佔畫面高度 45%」，實際畫出來只有約 8~13% ——
   **模型對百分比幾乎沒有反應，但對「和某某一樣大」有反應**（機器就是這樣被畫對的）。
   → 這一輪改成：**整顆牙（含埋住的）和整台機器一樣長、和機器的圓筒一樣厚**；
   **露出的牙冠和刀盤的直徑一樣高**。
2. **電牌要按「三分之一」分配。** 「整條都要有」寫成「左三分之一至少三面、
   中三分之一至少三面、右三分之一至少三面」——**給位置配額，不要只給總數**
   （給總數它就全部塞在同一段）。
3. **人物風格要寫進提示詞本身，不能只靠參考圖**（使用者這次沒附圖就跑掉了）。
   → 新增一段把這一站的人臉畫法逐項寫死：一色平塗的臉、點眼睛沒有眼白、
   兩道短眉、鼻子只有一小筆、小小的嘴、臉頰可以一小塊紅暈、頭髮是兩階的平塗塊、
   東亞面孔、頭約身高的七分之一、線細而有粗細變化。
   ⚠ 這一段要**放在提示詞前段**（和風格錨點放在一起），不要留在最後。

（完整提示詞見下一節。）

---

## 三十、第十三輪的完整提示詞（2026-08-25，全新生成）
...
describe light, fine paper grain over the whole image. Every surface carries drawn detail: the
tunnel lining has joint lines, rows of small round bolt heads and a steel rib arch every few
metres; the earth is drawn in three clearly different browns with strata lines, many small
pebbles, speckles and fine root hairs; the machine has panel seams and bolt rows. Apart from the
calm band at the top, no patch bigger than about a tenth of the picture is flat empty colour.
Keep the picture from going pale: the lining is a mid-tone lilac-grey rather than a washed-out
one, its lower half carries a band one step darker, each rib arch has a shadow down both sides,
and about a third of the machine's shell is in its mid-grey shade.
...
and scrubs is pushing a big white hand-held tunnel shield towards the right, into the last
stretch of soil, and the crown of an enormous tooth has just appeared in the ground ahead of it.
The tooth lies flat and most of it is still packed under solid earth. Deep under the tunnel
floor, a glowing violet high-voltage cable, hung with small warning plates all the way along it,
runs from the left edge to the right edge and rises only to skim past the tooth. Her assistant
hauls the very thick hydraulic hose behind her, and a young patient in his twenties with a friend
of the same age have lit up with excitement: there it is. Everybody is happy and lively. It is
the moment of finding, not of fighting.

The whole picture is underground: no sky, no grass, no view of the ground surface, no daylight
opening.

The machine faces right. The round cutter face is the rightmost part of the whole machine: it
stands at the right-hand end of the cylinder, pressed against the brown earth on the right, and
it faces away from everybody, towards the right edge of the picture. To its left come the short
thick cylindrical shield of the same big diameter, two short hydraulic rams, and a slimmer body.
The two grips are at the left-hand end of the machine, nearest the surgeon, and the thick hose is
...
clear shading. It is an engineering tool, never a weapon.

The tooth is far bigger than in the last version - roughly two and a half times bigger - and its
size is best judged against the machine, not in percentages. The whole tooth, buried part
included, is about as long as the whole machine from cutter face to grips, and about as thick as
the machine's cylinder is tall. It is the biggest single object in the picture apart from the
tunnel itself, and it fills most of the right-hand third of the image. Keep exactly the treatment
of the last version, only much larger: the clean crown breaking out of the soil while the rest
stays buried, which worked well. In detail: the tooth lies flat, its long axis horizontal like a
fallen pillar, never upright and never tilted; its crown end points left towards the machine and
its two thick roots point right, horizontally, towards the right edge, never downwards. The
uncovered part is the whole crown of a molar - a rounded biting surface with two or three low
cusps, bulging sides that draw in again at the neck - and that exposed crown alone is about as
tall as the cutter face is wide. It is drawn solid and clean in cream white (#f2ece2, shaded
#d9cfc0), bright in the lamplight, with three or four short straight light strokes radiating from
it. It is never a shard, a wedge, a chip or a pointed white stone. A wavy edge of soil crosses
the tooth just behind the crown; to the right of that edge there is only brown soil, drawn with
its own strata lines, pebbles, speckles and root hairs running right across it, clearly
overlapping the edge of the tooth so the soil is obviously lying on top of it, and there the
tooth shows only as a faint dotted outline, like an excavation survey drawing - never clean
white, never solid, never inside an open hollow or dark cavity, never with an air gap around it.
Between the cutter face and the exposed crown there is an open gap of undug earth about half the
width of the shield, so the crown stands free with nothing in front of it. It has no face.

The glowing violet high-voltage cable runs the entire width of the picture and is signposted
along its entire length - the last version bunched all the plates into the bottom right corner,
which is wrong. The cable enters at the left edge well below the tunnel floor line, runs right
through the cutaway soil, and rises only where it reaches the tooth, still inside the earth, to
skim around the outside of the tooth before leaving at the right edge. Now place the warning
plates so that they are spread over the whole width: at least three plates in the left third of
the picture, at least three in the middle third, and at least three in the right third, spaced at
roughly even intervals along the cable from the left edge to the right edge, each planted in the
soil beside it. Each plate is a simple yellow triangle with a black zigzag lightning bolt inside
it, on a short grey stake about as tall as a person's hand, and each plate is blank apart from
that lightning symbol. The cable itself stays calm and pretty: a smooth rounded tube of gently
glowing pale violet light (#b48fc0 with a lighter #d6bfdd core), not red, not flashing, not
crackling. It never comes up into the tunnel, never touches the floor and never enters the tooth.

The hydraulic hose must never be confused with that cable. It is ribbed, dull grey-brown, as
...
floor line, never glows, and never touches or joins the cable; between the two there is always a
clearly visible band of drawn soil.
...
horizontal joint lines and nothing else, and it must be clearly lilac-tinted, never a neutral
grey, never near-white, never brown. Nothing may cross into it: no head, no cap, no raised hand,
no tooth, no machine, no lamp, no lamp chain, no rock. Compose so that every head, every lamp,
the top of the machine and the top of the tooth sit below a line one fifth of the way down from
the top, about 126 pixels of the 628.
...
facing right, standing just left of the machine and leaning her weight into it: one foot forward,
one braced back, knees bent, both hands on the two grips at the machine's left-hand end. Her hair
is a short dark-brown bob ending at the jaw with a soft fringe, and the violet cap is worn pushed
back on her head so the fringe and the ends of the bob show clearly in front of it and below it.
The cap is a soft tie-back surgical cap, plain, with no pattern, in muted violet (#8e6299, shaded
#784e84). She wears an open white coat over pale grey-violet scrubs (#c9bcd0). No face mask. She
is smiling with delight: mouth a small upward curve, eyes creased into two happy upward curves,
eyebrows raised. She is about 62% of the picture height, steady and in control, not straining
painfully, not looking at the viewer.
...
body leaning back against its weight, head up, mouth a small open oval of delight, eyes creased,
eyebrows high. There is no wheeled unit, trolley or generator anywhere on the floor.
...
straight at the exposed crown, the other fist raised beside his chest, body leaning forward, one
heel lifted mid-step, mouth a small open oval, eyebrows high, eyes bright, with two or three
short ink strokes beside his raised arm to show the movement. His friend is the same age, a young
woman with a high ponytail in a soft teal jacket and dark trousers, about 50% of the picture
height, standing right beside him with one hand on his upper arm and the other hand raised open
beside her face, laughing and looking where he points. Neither of them is anxious, holding a
cheek, wearing a hard hat, or looking at the viewer. They are the liveliest part of the picture.

Colour and light: warm lamplight from the two ceiling lamps, and the brightest thing in the
picture is the newly uncovered crown. Lining mid-tone lilac-grey; machine off-white with a third
of it in shade; earth warm pale brown (#c8ab86, shaded #a5855f and #8d7250) in three clear flat
steps; boulders cooler grey-brown; ceramic pipe and clay jars warm terracotta; tooth cream white;
the patient's sweatshirt warm ochre; his friend's jacket soft teal; warning plates warm yellow;
hose dull grey-brown. Most colour blocks sit around HSL saturation 30-50 and lightness 70-85. No
dusk, no orange cast, no black shadows.

Composition anchors: the lilac lining band runs across the very top with nothing above it; the
tunnel floor line runs across at about two thirds of the height; the bottom third is cutaway
earth with the glowing cable and its evenly spread warning plates; the young patient and his
friend stand at the left inside the tunnel with the ribbed hose running out past them off the
left edge, well above the cable; the assistant is at the centre hauling that hose; the surgeon
stands right of centre facing right with both hands on the grips at the machine's left-hand end;
the machine lies to her right with its cutter face at its far right pressed into the earth; the
huge tooth fills most of the right-hand third, its clean crown standing free in the gap beyond
the cutter face and the rest of it dotted under drawn soil; boulders, the ceramic pipe, the root
and the clay jars sit in the earth below the floor and at the right-hand end; everything that
must be read sits inside the middle 73% of the width.

Avoid: any writing, letters, words, numbers or labels anywhere; writing on the warning plates;
warning plates bunched together in one corner or missing from the left half of the picture; a
cutter face on the left-hand end of the machine; a cutter face pointing at the surgeon or the
viewer; a hose, cable, grip or hand attached to the cutter face; a small tooth; a tooth smaller
than the machine; an exposed part that reads as a wedge, shard, chip or pointed stone rather than
a tooth crown; a tooth standing upright; roots pointing down; a tooth with a face; a whole clean
tooth fully out of the ground; a buried stretch drawn in clean white instead of soil; an open
cavity or dark void around the tooth; the cable entering the tooth, coming up into the tunnel, or
touching or joining the hose; a hose that glows; big-headed, chibi, elongated or western-cartoon
...
lining; a bare, flat, undetailed lining; a pale, empty or unfinished-looking picture; boulders,
roots, jars or debris inside the tunnel; a wheeled trolley or generator on the floor; a thin
hose; a lilac or pastel machine shell; a flat pure white machine with no seams; sky, clouds,
grass, daylight; muzzle flash, bullets, cartridges, ammunition belts, military uniforms,
camouflage, soldiers; rivets, boilers, chimneys, smoke, steam, brass, spoked wheels, exposed
gears, chains, steampunk machinery; dental pliers, forceps, syringes, needles, scalpels, dental
drills, trays of instruments, operating theatres; hard hats, high-visibility vests, hazard tape;
treasure chests, gold coins, jewels, glitter, stars, sparkles, confetti; blood, wounds, pain,
fear, cracks, decay, stains; a mouth seen from inside; gums, jawbones, labelled anatomy, X-ray
films; patterned or printed caps; a cap that hides all of the surgeon's hair; anybody looking at
the viewer; any person drawn faded, translucent, ghostly or outline-only, since the dotted
treatment belongs only to the buried part of the tooth; panels, insets, frames, borders, speech
bubbles, arrows, small icons; large flat empty areas; dusk, sunset, golden hour, an orange or
sepia cast; photorealism; 3D rendering; heavy even black outlines.
```

⚠ **餵圖**：第一張放**第十二輪那張生成圖**（「線、密度、隧道、機器方向照這一張；
但**牙齒要放大兩倍半**、**電牌要整條都有**」），再加
`drafts/surg-doctor-ref.jpg`、`drafts/surg-patient-ref.jpg`（人物長相與畫法）。

---

## 三十一、第十四輪：牙齒要有「剛被挖出來」的樣子（2026-08-25）

使用者：「**差不多了，剩下一個** —— 這個牙齒**沒有被露出來的樣子**，**感覺被大家忽略了**。」
...
| 邊緣密度 | 30.4% ✓ | ≥ 30% |
| 無彩空白 | 1.1% ✓ | < 5% |
| 頂 17% 中位 RGB | 181/168/186 ✓（比前幾輪深，仍過） | 藍 ≥ 178 |
| 圖上有沒有字 | 0 ✓ | 0 |
| 牙齒大小 | ✅ 放大到位 | — |
| 電牌分布 | ✅ 整條都有了 | — |
...
1. **沒有「剛挖開」的痕跡。** 牙冠和周圍的土用同一種邊緣畫，看起來是「本來就長在那裡」，
   不是「剛被挖出來」。→ 要有**新挖的碗狀凹口**、**參差的新鮮土緣**、
   **落在地上的一小堆鬆土**與碎屑。
2. **牙冠沒有真的離開土面。** 現在整顆都貼在土裡。
   → 牙冠要**凸出土面**（凸出量約刀盤直徑的一半），**在後面的土上投一小塊影子**，
   而且是全畫面**最亮、最乾淨**的東西。
3. ⚠⚠ **沒有人在看它。** 四個人裡只有病人指著它，其他三個人的視線各自散開 ——
   **「被忽略」是視線的問題，不是大小的問題。**
   → 四個人的臉與視線**全部朝同一點**（醫師也要看），彼此不對看、不看鏡頭。

⚠ 這一條可以推廣：**要讓畫面裡某個東西變成主角，先問「有沒有人在看它」** ——
第十之二節那個「置身事外」的牙齒是同一件事的反面
（那次是角色不看醫師，這次是所有人不看那顆牙）。

（完整提示詞見下一節。其餘每一段都和第十三輪逐字相同，只換牙齒與視線那兩段。）

---

## 三十二、第十四輪的完整提示詞（2026-08-25，全新生成）
...
hand-held tunnel shield, and the crown of an enormous tooth has this second come free of the
earth in front of everyone. All four people are looking straight at it. The rest of the tooth is
still packed under solid ground. Deep under the tunnel floor, a glowing violet high-voltage
cable, hung with small warning plates all the way along it, runs from the left edge to the right
edge and rises only to skim past the tooth. Everybody is happy and lively. It is the moment of
finding, not of fighting.

The whole picture is underground: no sky, no grass, no view of the ground surface, no daylight
opening.

The most important thing in this brief: the tooth must look as if it has just been uncovered this
very moment, and every person must be looking at it. The last version failed on both counts - the
tooth looked as though it had always been sitting there, and the people were looking in different
directions, so the find was ignored. Do all five of these things:
  First, dig a fresh bowl-shaped hollow into the soil face around the crown, with a ragged,
  freshly cut edge, so it is obvious that soil has just been taken away from around it.
  Second, let the crown stand right out of that hollow into the open air of the tunnel, sticking
  out by about half the width of the cutter face, and cast a small soft shadow from it onto the
  soil behind it, so it plainly is not still embedded.
  Third, pile a small heap of loose fresh soil and crumbs on the tunnel floor directly below the
  crown, with a few crumbs still tumbling.
  Fourth, make the crown the brightest and cleanest thing in the whole picture: one of the
  ceiling lamps throws a warm pool of light straight onto it, and three or four short straight
  ink strokes radiate from it.
  Fifth, turn every face towards it. The patient points at it and looks at it; his friend looks
  at it; the assistant looks at it; the surgeon looks at it. All four sets of eyes converge on the
  crown - nobody looks at anybody else, nobody looks at the viewer, nobody looks away.

The tooth itself: it lies flat, its long axis horizontal like a fallen pillar, never upright and
never tilted; its crown end points left, towards the machine and the people, and its two thick
roots point right, horizontally, towards the right edge, never downwards. The whole tooth, buried
part included, is about as long as the whole machine from cutter face to grips, and about as
thick as the machine's cylinder is tall - the biggest single object in the picture apart from the
tunnel itself. The uncovered part is the whole crown of a molar: a rounded biting surface with
two or three low cusps, bulging sides that draw in again at the neck, and that exposed crown
alone is about as tall as the cutter face is wide. It is drawn solid and clean in cream white
(#f2ece2, shaded #d9cfc0), never a shard, a wedge, a chip or a pointed white stone. Behind the
crown, a wavy edge of soil crosses the tooth; to the right of that edge there is only brown soil,
drawn with its own strata lines, pebbles, speckles and root hairs running right across it,
clearly overlapping the tooth so the soil is obviously lying on top of it, and there the tooth
shows only as a faint dotted outline, like an excavation survey drawing - never clean white,
never solid, never inside an open hollow, never with an air gap around it. It has no face.
...
the left of the fresh hollow, so that it never covers, touches or hides the crown; between the
cutter face and the crown there is an open gap of undug earth about half the width of the shield.

The glowing violet high-voltage cable runs the entire width of the picture and is signposted
along its entire length. It enters at the left edge well below the tunnel floor line, runs right
through the cutaway soil, and rises only where it reaches the tooth, still inside the earth, to
skim around the outside of the tooth before leaving at the right edge. Place the warning plates
so they are spread over the whole width: at least three in the left third of the picture, at
least three in the middle third and at least three in the right third, spaced at roughly even
intervals, each planted in the soil beside the cable. Each plate is a simple yellow triangle with
a black zigzag lightning bolt inside it, on a short grey stake about as tall as a person's hand,
and each plate is blank apart from that lightning symbol. The cable itself stays calm and pretty:
a smooth rounded tube of gently glowing pale violet light (#b48fc0 with a lighter #d6bfdd core),
not red, not flashing, not crackling. It never comes up into the tunnel, never touches the floor
and never enters the tooth.
...
The tunnel is big enough to walk through. Its crown and far wall are lined with curved concrete
segment panels in mid-tone lilac-grey (#d3cbdd, shaded #b3a9c2). The floor is packed earth with a
scatter of small pebbles. Two small ceiling lamps hang from the crown; one of them lights the
people, the other throws its pool of light onto the newly uncovered crown of the tooth. Inside
the tunnel everything is clear and tidy: apart from the people, the machine, the hose and the
fresh heap of soil below the find, nothing is lying about in it.
...
the gleaming crown are just to the right of it, about three quarters of the way across, with the
heap of loose soil beneath them; the buried rest of the tooth runs from there to the right edge
under drawn soil, dotted; boulders, the ceramic pipe, the root and the clay jars sit in the earth
below the floor and at the right-hand end; every face in the picture is turned towards the crown;
everything that must be read sits inside the middle 73% of the width.

Avoid: any writing, letters, words, numbers or labels anywhere; writing on the warning plates;
warning plates bunched into one corner; a tooth that looks as if it had always been sitting in
the ground; a crown still flush with the soil face; no fresh hollow, no loose crumbs, no heap of
dug soil; anybody looking away from the crown; people looking at each other or at the viewer; a
cutter face on the left-hand end of the machine; a cutter face pointing at the surgeon or the
viewer; a hose, cable, grip or hand attached to the cutter face; the machine covering or touching
the crown; a small tooth; a tooth smaller than the machine; an exposed part that reads as a
wedge, shard, chip or pointed stone; a tooth standing upright; roots pointing down; a tooth with
a face; a whole clean tooth fully out of the ground; a buried stretch drawn in clean white
instead of soil; an open cavity or dark void around the tooth; the cable entering the tooth,
coming up into the tunnel, or touching or joining the hose; a hose that glows; big-headed, chibi,
elongated or western-cartoon characters; wide toothy grins; visible teeth in anybody's mouth;
eyes with whites, pupils or highlights; face masks on anybody; an elderly patient; a lone patient
with nobody accompanying him; a view down the bore of the tunnel; one-point perspective; anybody
seen from the front or from behind; tiny distant figures; a strip of soil, rocks or roots along
the top edge above the lining; a bare, flat, undetailed lining; a pale, empty or
unfinished-looking picture; boulders, roots, jars or debris inside the tunnel; a wheeled trolley
or generator on the floor; a thin hose; a lilac or pastel machine shell; a flat pure white
machine with no seams; sky, clouds, grass, daylight; muzzle flash, bullets, cartridges,
ammunition belts, military uniforms, camouflage, soldiers; rivets, boilers, chimneys, smoke,
steam, brass, spoked wheels, exposed gears, chains, steampunk machinery; dental pliers, forceps,
syringes, needles, scalpels, dental drills, trays of instruments, operating theatres; hard hats,
...
## 三十五、第十六輪：只補人物參考圖，外加一句「頂端那條要保持淺」（2026-08-25）

使用者：「**我忘記加人物參考圖了，剩這個要改。**」——所以這一輪**不改構圖、不改內容**，
只把兩張人物參考圖餵進去重跑。
...
| 邊緣密度 | 28.6%（差 1.4） | ≥ 30% |
| 無彩空白 | 1.4% ✓ | < 5% |
| 頂 17% 中位 RGB | ⚠ **169/157/169** | 藍 ≥ 178 ✗ |
| 頂 17% 被佔到 | 第 101 列 ✓ | 0 |
| 圖上有沒有字 | 0 ✓ | 0 |
| 粗管線／電牌／露三分之一 | ✅ 三件都到位 | — |

⚠⚠ **襯砌整片被畫暗了**（前幾輪 196/183/200 ~ 208/201/217，這次掉到 169/157/169），
藍通道 169 < 178，**帶子就追不到口外的套色**（補償色算出 269，超過 255）。
成因是第十五輪為了救無彩空白，我把「lining 要 mid-tone 不要 washed out」寫得太重，
**模型連頂端那條一起壓暗了**。

→ 修法是**只加一句**：頂端那 17% 的襯砌要維持**淺**的淡紫灰（`#d3cbdd` 那一階），
**深一階的只有牆的下半段**。其餘一個字都沒動。
