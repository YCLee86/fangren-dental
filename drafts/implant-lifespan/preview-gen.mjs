...
out = out.slice(0, bodyStart) + `    <p class="lede">「植牙可以用一輩子嗎？」這是還沒決定要不要做的人，最常問的一句。</p>
    ...
    <p>數字看得出差距：<a href="https://doi.org/10.1111/joor.12431" target="_blank" rel="noopener">磨牙者的植體失敗率 13.0%、非磨牙者 4.6%</a>；<a href="https://doi.org/10.1111/cid.12300" target="_blank" rel="noopener">另一份統合分析</a>算出磨牙者的失敗風險約是非磨牙者的四倍。除了失敗，螺絲鬆脫、假牙崩瓷、支架斷裂這些機械性的問題也比較常出現。有磨牙習慣不代表不能植牙，但咬合的設計與夜間的保護裝置要一起規劃。</p>
    ...
    <dl class="keypoints">
      ...
      <dt>會磨牙的人可以植牙嗎？</dt>
      <dd>可以，但風險比較高：磨牙者的失敗率 13.0%、非磨牙者 4.6%。植體沒有牙周韌帶當緩衝，力量會直接傳到骨頭與零件上，所以咬合的設計與夜間的保護裝置要一起規劃。</dd>
