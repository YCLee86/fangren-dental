...
const DESC  = '1965 年植入的那四顆，用了四十年直到他過世。但十年、二十年的群體數字說的是另一件事：植牙能用多久，一半取決於植入之後的清潔與回診。';
...
out = out.slice(0, metaStart) + `<script type="application/json" id="post-meta">
{
  ...
  "title": "${TITLE}",
  "excerpt": "1965 年植入的第一組鈦植體，用了四十年直到他過世；第二位患者的十一顆，紀錄上至少用了四十八年。但十年 96.4%、二十年約八成的群體數字，以及「存活」與「成功」的差別，說的是另一件事：植牙能用多久，一半取決於植入之後。",
  "tag": "缺牙重建",
  "author": "芳仁牙醫診所 編輯室",
  "published": "【上線那天填】",
  "hero": "【還沒畫】",
...
out = out.slice(0, bodyStart) + `    <p class="lede">「植牙可以用一輩子嗎？」這是還沒決定要不要做的人，最常問的一句。</p>
    ...
    <p>回到最初那個問題。1965 年那四顆用了四十年，直到他生命的終點；1967 年那十一顆，紀錄上至少服役了四十八年。<strong>所以「植牙能用多久」從來不是一個關於品牌的問題。</strong>它取決於三件事：</p>
    <ul>
