...
ok(imgs.length === 30, `頁上有 ${imgs.length} 張圖，應該是 30`);
const used = new Set();
for (const im of imgs) {
  ...
  if (/^(post-map-|door-(c|c110|c130|c130-nsb|c130-nsd|c130-m2|c130-m3|c130-m4|c145|c160|c-title|c-qr|a|b|noqr|qr140|north)\.png)/.test(im.src))
