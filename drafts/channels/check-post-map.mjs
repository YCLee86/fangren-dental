...
ok(imgs.length === 59, `頁上有 ${imgs.length} 張圖，應該是 59`);
const used = new Set();
for (const im of imgs) {
  ...
  if (/^(post-map-|far-(?!profile|slot)|door-(c|c110|c130|c130-nsb|c130-nsd|c130-m1|c130-m2|c130-m4|c130-w0|c130-w1|c130-w3|c130-w4|c130-wbr|c130-x1|c130-x3|c130-x4|c130-l1|c130-l2|c130-l3|c130-l4|c145|c160|c-title|c-qr|a|b|noqr|qr140|north)\.png)/.test(im.src))
