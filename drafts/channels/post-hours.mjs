 ...
 *   全部是 PALETTE.md 既有的值。
 * ⚠ 一律 headless_shell（DECISIONS.md 第九節第 18 條：完整版 chrome 畫出來會比
 ...
 *
 *   ⚠⚠⚠ 通則（已進 DECISIONS.md 第九節第 28 條第 ⑤ 項）：
...
/* ---------- 「讀起來對不對」一次印完（2026-09-07 的檢討，見 DECISIONS.md 第九節第 28 條）
 ...
 * ⚠ 第二件：**自己推導出來的限制在壓縮版面時要當場講**（安全帶那一行）。 */
{
  ...
  if (room > -1 && room < 12)
    console.log(`  ⚠⚠ 安全帶只剩 ${room.toFixed(0)}px —— **這條限制正在壓縮版面**，`
      + `再要加東西就得先跟使用者攤開取捨（DECISIONS.md 第九節第 28 條 ③）`);
}
