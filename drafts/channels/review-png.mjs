 ...
 *   為什麼寫 ＝ 幫到下一個人（w=a）／意見那一塊 ＝ 只跟櫃檯說（f=desk）。
...
const query = OLD ? "?v=old" : "?v=new&w=a&f=desk";
const out = path.join(DIR, OLD ? "shot-review-old.png"
  : CHAT ? "shot-review-chat.png" : "shot-review.png");
