...
const RULE = "#cdd0d2";
const 尺區 = `<div class="h2">Ⓟ 分隔線要多淡<span class="t">同一支柔墨往白色混，色相一個度都沒有動</span></div>
...
<div class="note"><p>⚠ 這一把畫在<b>定案那一格的顆數</b>上（${BAND.顆數} 顆 ＝ 基數 ${S.帶子.顆數} × ${S.帶子.倍}）——
顆數那把尺 2026-09-16 已經挑定（Ⓜb），帶子條收掉了，四格量出來的數字改印在產生器的面板上。</p>
