...
const ITEMS = [
  ...
  { n: "⑤", title: "預約成功 ＋ 約診紀錄查詢", when: "同一張卡的兩個狀態", askLabel: "廠商回覆：",
    ...
    note: "<b>背景色：<code>#FFFFFF</code>（維持白底）</b> —— 2026-09-14 定案，"
      + "<b>而你們現在跑的就是純白，這一項不必換</b>："
      + "逐像素量過你們 09-10 送來的三張截圖，卡片內部是 <code>#FFFFFF</code>；"
      + "先前我們這一份寫的是 <code>#F4F4F5</code>（診所網站的卡片色），同一天已經改成純白對齊你們，"
...
/* ---------- 模擬圖 ------------------------------------------------------
   ⚠⚠ 擺的是**那幾頁自己拍的真產出檔**，不是用 CSS 再畫一次（LINE.md 第十一之五節）。
