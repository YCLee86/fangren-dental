...
<div class="pv-bar">
  ...
  <div class="pv-row" data-k="dx">
    ...
    <button type="button" data-v="2">貼齊</button>
    <button type="button" data-v="3">出血</button>
    <button type="button" data-v="4">出血＋</button>
  </div>
...
(function () {
  ...
  var DXM = { "0": "0px", "1": "10px", "2": "14px", "3": "14px", "4": "14px" };
  var BLM = { "0": "0px", "1": "0px",  "2": "0px",  "3": "18px", "4": "36px" };
  ...
  var DXD = { "0": "0px", "1": "12px", "2": "20px", "3": "20px", "4": "20px" };
  var BLD = { "0": "0px", "1": "0px",  "2": "0px",  "3": "24px", "4": "48px" };
