...
function BODY() { return `    <p class="lede">因為「右下那一顆在痛」或「那邊的牙齦腫起來了」來看牙，醫師檢查完卻說：「我們先幫你做全口的牙周檢查和治療。」心裡難免有疑問：明明只有一個地方不舒服，為什麼要處理整口牙？簡單的答案是：<strong>會痛的那一顆，通常是最嚴重的一顆，卻不是唯一生病的一顆。</strong></p>
    ...
    <p>先有一個尺度：<strong>牙根埋在骨頭裡大約十三毫米</strong>，健康的牙齦溝只有 1 到 3 毫米。囊袋變深，代表牙根上段已經和牙齦、骨頭分開。粗略換算，<strong>5 毫米的囊袋大約流失了四分之一的牙根，7 毫米以上接近四成</strong>；牙齦如果已經退縮，實際流失的還要更多。這只是一個概念，確切還剩多少，要看檢查紀錄搭配 X 光。</p>
