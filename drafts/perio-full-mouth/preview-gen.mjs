...
function BODY() { return `    <p class="lede">因為「右下那一顆在痛」或「那邊的牙齦腫起來了」來看牙，醫師檢查完卻說：「我們先幫你做全口的牙周檢查和治療。」心裡難免有疑問：明明只有一個地方不舒服，為什麼要處理整口牙？簡單的答案是：<strong>會痛的那一顆，通常是最嚴重的一顆，但很少是唯一生病的一顆。</strong></p>
    ...
    <dl class="keypoints">
      ...
      <dd>牙周病大部分時候不痛，會腫會痛的那一顆，通常只是最嚴重、最先出現症狀的一顆。其他牙齒可能也有囊袋加深、骨頭流失，只是還沒到會痛的程度。研究也發現，只檢查一部分牙齒，會漏掉一半以上的重度牙周病，所以每一顆都要量。</dd>
      ...
      <dt>治療完為什麼還要再檢查一次？</dt>
      <dd>牙根埋在骨頭裡大約十三毫米，5 毫米的囊袋大約代表四分之一的牙根已經失去附著。治療後留下的深囊袋，和日後掉牙的關係很大：和 3 毫米以內相比，留下 5 毫米的牙齒日後掉牙的機會約 7.7 倍、6 毫米約 11 倍、7 毫米以上約 64 倍。牙周治療的成果要一顆一顆算，清不到底的地方要再評估。</dd>
