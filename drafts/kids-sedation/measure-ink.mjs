...
// 正規化座標 [x0, y0, x1, y1]
const people = {
  "醫師":   [0.19, 0.22, 0.45, 0.99],
  "媽媽":   [0.615, 0.36, 0.79, 0.95],
  "爸爸":   [0.735, 0.09, 0.93, 0.98],
  "小孩":   [0.605, 0.54, 0.735, 0.99],
};
// ⚠ 對話框**不算人**，不進「線一樣實」的比較 —— 它框內大半是白底，
//   最暗 5 百分位會被白底拉高（第一次跑量到 53.4，害整組誤判成不過）。
//   單獨印出來當參考就好。
const extra = { "對話框": [0.29, 0.04, 0.72, 0.36] };
