...
const CASES = [
  ...
  /* 使用者 2026-09-03：「Ⓒ3，但建築可以再往左一點，最左不要超過 Ⓓ。」
     ⚠ 這一次**不必動 2:1**：窗框大小不變，整個往右滑（左邊多裁、右邊少裁），
     所以天空、路面、屋簷上方的餘量全部和 Ⓒ3 一模一樣，只有建築在畫面裡的位置變。
     四階平均分佈在 Ⓒ3 的 9% 到 Ⓓ 的 13% 之間；13% 是上限（屋簷左緣在 13.5%）。 */
  { id: "c3a", label: "Ⓒ3a 往左一階",        L: 10.34, R: 93.84, bottom: 94 },
  { id: "c3b", label: "Ⓒ3b 往左兩階",        L: 11.67, R: 95.17, bottom: 94 },
  { id: "c3c", label: "Ⓒ3c 到 Ⓓ 的極限",     L: 13,    R: 96.5,  bottom: 94 },
];
