...
## ⛔ 結果：第一版被退回，而且**這張圖不要再改了**

產出 `hero-edit-v1-rejected.jpg`。使用者：「好像沒差多少」。**量完證實他是對的。**
完整的五條在 ILLUSTRATION.md **第十八之十二節**，摘要：

| | 結果 |
| --- | --- |
| **圖太小** | 少年的頭在手機上只有 **14.1px**、弧線 **4.6px**。⛔ **標記再畫對都沒有用** |
| 弧線 | 尺寸墨量**完全命中規格**（33%／6%），但**語意被我記錯** —— 那是「正在講電話」，要有手和手機 |
| 星星 | **五角、頭高 60%、墨量 65%**，像貼紙。成因：畫面裡沒有先例的形狀，模型會拿 clipart |
| 改圖 | ⚠ Gemini **整張重畫**（6.60% 像素有差、平均散在每一格），中央螢幕有可見退步 |
| 串台 | ✅ **沒有發生**，三個配套有效 |

**由此定出一條新規則（十八之四）：頭在母檔裡至少要 180px 高，標記才用得上。**
這張只有 84px。**下一次要試，先量頭高再挑題目。**
