...
/* 第三輪（2026-09-25）使用者挑定 Ⓒ 卡片底 ＋ 矯正科的藍灰 ＋ 圓角 18%（他手機截圖上亮著的那三格），
   要的是「上線後長什麼樣」—— 切換條預設收起來，網址帶 ?pv=1 才出現。 */
.pvbar { display: none; }
:root[data-pv="1"] .pvbar { display: block; }
</style>
<div class="pvbar">
...
(function () {
  ...
  var KEYS = { pos: ['a','b','c'], c: ['blue','spec'], r: ['18','27','38'] }, DEF = { pos: 'c', c: 'spec', r: '18' };
  var st = { pos: DEF.pos, c: DEF.c, r: DEF.r }, qs = new URLSearchParams(location.search);
  if (qs.get('pv') === '1') root.setAttribute('data-pv', '1');
