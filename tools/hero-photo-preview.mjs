...
const READY = [
  ...
  },
  {
    ...
    alt:
      "明亮的牙醫診所櫃檯前：一位老太太遞出蓋滿一整排小牙齒章的卡片，穿綠色制服的櫃檯人員" +
      "正把印章蓋在下一格上，兩人都在笑；一個小男孩踮著腳、下巴剛好搆到檯面，仰頭盯著蓋章那一下，" +
      "媽媽站在後面放下心地看著他。左邊長椅上還有戴耳機的少年、看書的男子、共看一支手機的年輕情侶、" +
      "拄拐杖的老先生，一個小女孩蹲在玩具籃旁邊玩積木；牆上三張只有圖沒有字的牙齒海報，" +
      "右邊門內看得到診療椅，檯面上放著透明的牙齒模型與一排牙刷",
    src: "Gemini_Generated_Image_2m6vfb2m6vfb2m6v.jpg（2752×1536，使用者 2026-08-16 提供）",
  },
  {
    slug: "missing-tooth",
    photo: "hero-implant-photo",
    oldHero: "hero-implant.svg",
    alt:
      "三格連續的畫面：火鍋桌旁的朋友夾起一片肉遞過來，右邊身形偏瘦的年輕女性舉起雙手推辭，" +
      "她的思考泡泡裡是自己皺著眉、手扶臉頰，怎麼也咬不動那片肉；" +
      "夜市的鹹酥雞攤前朋友遞上一袋炸物，左邊的中年男子舉手婉拒，" +
      "他的思考泡泡裡是自己在浴室鏡前用手指撥開臉頰，看著後排少了一顆牙；" +
      "家族聚餐的圓桌擺滿螃蟹、蝦子、排骨與滷肉，背對鏡頭的兩位親人把一盤肉遞過去，" +
      "對面的中年女性舉手推辭，她的思考泡泡裡是自己晚上獨自在家舀著一碗清粥",
    src: "Gemini_Generated_Image_ifa9smifa9smifa9.jpg（2752×1536，使用者 2026-08-16 提供）",
  },
];
