...
const NOTE = `<!-- ==========================================================================
     ...
     現在的影子是**畫出來的**：同一條釘身路徑疊十六層，每層往下挪一點、
...
(function () {
  ...
  var SH = {
    off: null,
    s1: { a: .022, dy: 1.5, sp: .18, max: 61, area: 295 },
    s2: { a: .032, dy: 2.5, sp: .30, max: 86, area: 575 },
    s3: { a: .041, dy: 3.5, sp: .42, max: 93, area: 849 },
    s4: { a: .051, dy: 5.0, sp: .55, max: 120, area: 1172 }
  };
  ...
  function drawPin() {
    ...
    drawShadow(pbody.getAttribute('d'), d);
    return { H: H, R: R, w: w };
  }
