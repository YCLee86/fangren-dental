...
const OG_ALT = {
  ...
  endo: "明亮的診間裡，醫師坐在醫師椅上、眼睛貼著牙科顯微鏡，鏡頭的暖光打在一顆站著的大牙齒上；"
      + "牙齒一隻手按著自己肩上那塊淡淡的髒污，抬頭看著醫師；右上角一個大圓圈把那塊表面放大，"
      + "看得到一條細縫，和九隻正在縫裡搗蛋的細菌。",
  ortho: "明亮的診間裡，矯正專科醫師站在一圈浮空的藍色螢幕之間，戴著藍色手套、指尖發亮，"
       + "正把主螢幕上牙弓裡一顆歪掉的牙移回它的位置；旁邊幾張小螢幕畫著牙齒上的矯正器與弓線，"
       + "坐在一旁的中年男性抬起手指著那顆牙，後方的助理在整理另一組螢幕。",
  prosth: "一道往右上走的階梯：左下角的階梯往畫面外延伸，一對五十幾歲的夫妻已經走了一段，"
        + "先生揮著手朝上面喊，白袍醫師在他們前面一階攤開一張地圖、指著上方；階梯中間兩個"
        + "掛著 1、2 號旗子的平台上，診所的人遞出水壺和毛巾、拍手招呼他們上去；"
        + "最上面的平台是一桌熱騰騰的飯菜，奶奶在桌邊雙手圈著嘴朝階梯下呼喚，"
        + "一個年輕人端菜過來，小女孩跪在椅子上揮手。",
  surg: "地底下一條加固過的隧道剖面：短髮女醫師戴著紫色手術帽，雙手推著一台白色的手持潛盾機往右挖，"
      + "助理扛著粗油壓管跟在後面，二十幾歲的年輕病人和同齡的朋友站在左邊指著前方歡呼；"
      + "右邊的土裡剛挖出一顆巨大臼齒的牙冠，其餘部分以虛線透出來，下方一條發光的紫色高壓電管沿路插著閃電警示牌。",
  kids: "明亮的兒童牙科診間裡，戴著塗鴉印花手術帽的醫師單膝蹲在診療椅旁，舉著一面小鏡子，"
      + "和坐在椅子上的小男孩平視；男孩笑著伸手指鏡子、腳在晃，媽媽站在右邊看著他，"
      + "妹妹跪在小凳上探頭，後方的助理正在檯面上放紙杯。",
};
...
const OG_DESC = {
  ...
  /* ⚠ 這一句是使用者 2026-08-25 逐字指定的，不是那一頁 close 的原文
     （close 是「難處理的那幾顆，交給口腔顎面外科專科醫師。」）——
     他要的是更短、更直接的說法，動它之前先問他。 */
  surg: "難拔的牙，交給口腔顎面外科專科醫師。",
};
const ogImage = (spec) => {
...
const introBlock = (spec, t, cnt) => `
      <!-- ===== 科別介紹（2026-08-18 版面定案）==========================
           ...
           ⚠⚠ **lead 與 stance 是兩種節奏**（2026-08-19）：
             ・stance 在後 ＝ 先讓他對號入座，再一句話回完（牙周）。
             ・lead 在前 ＝ 先把最重要的那句話講掉，再舉例（兒牙：家長最想聽的
               是「這不是孩子的體質」，那句話擺後面就太晚了）。
             ⚠⚠ **原本還有一條「一科只挑一種、不要兩個都給」，2026-09-20 取消了。**
             取消的成因是這一塊的標記：沒有 stance 就寫不出問答的 dl（只有 dt
             沒有 dd 不合法），那三科因此只能出 ul，被檢索系統讀成一串處境。
             ⚠ 當初的理由（同一件事講兩次、七頁像複製貼上）沒有失效，只是降級成
             寫作要求：**並存的時候 stance 不可以重講 lead 已經講完的事**。
             一般牙科、顯微根管、植牙假牙三科 2026-09-20 起兩個都有。
