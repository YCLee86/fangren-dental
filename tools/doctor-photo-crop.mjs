...
const FACES = {
  ...
  /* 林晏妤：⚠⚠ 戴手術帽、帽子很高、照片取景近 —— **整張寬 1051 就是最鬆的一格**。
     ...
     hair 這裡記的是**帽頂**。
     ⚠⚠ **同日第二輪換了照片**：使用者「林晏妤換這張 做預覽給我看」，提案頁
       preview/doctor-lin/ 一輪定案（「A定案上線」）。新照片取景和第一張幾乎一樣、
       背景換成冷灰的診間，量到 帽頂 150／眼睛 580／下巴 965／臉中線 548，
       同樣用整張寬 1051（頭高 78%、帽頂留白 4%）。原檔直接蓋掉 src/lin-yanyu.png，
       第一張在 git show 03f0e61c:drafts/doctor-photo/src/lin-yanyu.png（框 0,113,1051,1051）。 */
  "lin-yanyu": { name: "林晏妤", src: [1051, 1497],
    marks: { hair: 150, eyes: 580, chin: 965, midX: 548 },
    sq: [0, 108, 1051, 1051] },
